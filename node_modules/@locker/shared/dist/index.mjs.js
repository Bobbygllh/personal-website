...
const omnistudioPredicates$LWS = [key$LWS => key$LWS === 'omnistudio', key$LWS => ReflectApply$LWS(StringProtoStartsWith$LWS, key$LWS, ['devopsimpkg']), key$LWS => ReflectApply$LWS(RegExpProtoTest$LWS, /^devops\d{3}gs0/, [key$LWS]) // Matches devops001gs0, devops002gs0, etc
];
...
export { ArrayBufferIsView$LWS as ArrayBufferIsView, ArrayBufferProtoByteLengthGetter$LWS as ArrayBufferProtoByteLengthGetter, ArrayConcat$LWS as ArrayConcat, ArrayCtor$LWS as ArrayCtor, ArrayIsArray$LWS as ArrayIsArray, ArrayProtoFilter$LWS as ArrayProtoFilter, ArrayProtoFind$LWS as ArrayProtoFind, ArrayProtoIncludes$LWS as ArrayProtoIncludes, ArrayProtoIndexOf$LWS as ArrayProtoIndexOf, ArrayProtoJoin$LWS as ArrayProtoJoin, ArrayProtoMap$LWS as ArrayProtoMap, ArrayProtoPush$LWS as ArrayProtoPush, ArrayProtoShift$LWS as ArrayProtoShift, ArrayProtoSlice$LWS as ArrayProtoSlice, ArrayProtoSort$LWS as ArrayProtoSort, ArrayProtoSplice$LWS as ArrayProtoSplice, ArrayProtoToString$LWS as ArrayProtoToString, ArrayProtoUnshift$LWS as ArrayProtoUnshift, BigIntProtoValueOf$LWS as BigIntProtoValueOf, BooleanProtoValueOf$LWS as BooleanProtoValueOf, CHAR_QUOTE_DOUBLE$LWS as CHAR_QUOTE_DOUBLE, CHAR_QUOTE_SINGLE$LWS as CHAR_QUOTE_SINGLE, DateNow$LWS as DateNow, DateProtoValueOf$LWS as DateProtoValueOf, ENABLE_MAX_PERF_MODE_GATE$LWS as ENABLE_MAX_PERF_MODE_GATE, ENABLE_SANDBOXED_SAMEORIGIN_IFRAME_GATE$LWS as ENABLE_SANDBOXED_SAMEORIGIN_IFRAME_GATE, ERR_ILLEGAL_PROPERTY_ACCESS$LWS as ERR_ILLEGAL_PROPERTY_ACCESS, ERR_INVALID_SANDBOX_KEY$LWS as ERR_INVALID_SANDBOX_KEY, ErrorCtor$LWS as ErrorCtor, FunctionProtoBind$LWS as FunctionProtoBind, FunctionProtoToString$LWS as FunctionProtoToString, JSONParse$LWS as JSONParse, JSONStringify$LWS as JSONStringify, LOCKER_IDENTIFIER_MARKER$LWS as LOCKER_IDENTIFIER_MARKER, LOCKER_NEAR_MEMBRANE_IS_MASKED_SYMBOL$LWS as LOCKER_NEAR_MEMBRANE_IS_MASKED_SYMBOL, LOCKER_NEAR_MEMBRANE_SERIALIZED_VALUE_SYMBOL$LWS as LOCKER_NEAR_MEMBRANE_SERIALIZED_VALUE_SYMBOL, LOCKER_NEAR_MEMBRANE_SYMBOL$LWS as LOCKER_NEAR_MEMBRANE_SYMBOL, LOCKER_NEAR_MEMBRANE_UNMASKED_VALUE_SYMBOL$LWS as LOCKER_NEAR_MEMBRANE_UNMASKED_VALUE_SYMBOL, LOCKER_SERVICE_KEY$LWS as LOCKER_SERVICE_KEY, LOCKER_SERVICE_KEY_LOWERED$LWS as LOCKER_SERVICE_KEY_LOWERED, LOCKER_UNMINIFIED_FLAG$LWS as LOCKER_UNMINIFIED_FLAG, LockerSecurityError$LWS as LockerSecurityError, MapCtor$LWS as MapCtor, MapProtoEntries$LWS as MapProtoEntries, MapProtoSet$LWS as MapProtoSet, MapProtoSizeGetter$LWS as MapProtoSizeGetter, MathMin$LWS as MathMin, NumberIsFinite$LWS as NumberIsFinite, NumberIsInteger$LWS as NumberIsInteger, NumberIsNaN$LWS as NumberIsNaN, NumberProtoToFixed$LWS as NumberProtoToFixed, NumberProtoValueOf$LWS as NumberProtoValueOf, ObjectAssign$LWS as ObjectAssign, ObjectCtor$LWS as ObjectCtor, ObjectDefineProperties$LWS as ObjectDefineProperties, ObjectFreeze$LWS as ObjectFreeze, ObjectGetOwnPropertyDescriptors$LWS as ObjectGetOwnPropertyDescriptors, ObjectGetOwnPropertySymbols$LWS as ObjectGetOwnPropertySymbols, ObjectHasOwn$LWS as ObjectHasOwn, ObjectKeys$LWS as ObjectKeys, ObjectLookupOwnGetter$LWS as ObjectLookupOwnGetter, ObjectLookupOwnSetter$LWS as ObjectLookupOwnSetter, ObjectLookupOwnValue$LWS as ObjectLookupOwnValue, ObjectPreventExtensions$LWS as ObjectPreventExtensions, ObjectProto$LWS as ObjectProto, ObjectProtoToString$LWS as ObjectProtoToString, PromiseCtor$LWS as PromiseCtor, PromiseProtoCatch$LWS as PromiseProtoCatch, PromiseProtoThen$LWS as PromiseProtoThen, PromiseReject$LWS as PromiseReject, PromiseResolve$LWS as PromiseResolve, ProxyCtor$LWS as ProxyCtor, ReflectApply$LWS as ReflectApply, ReflectConstruct$LWS as ReflectConstruct, ReflectDefineProperty$LWS as ReflectDefineProperty, ReflectDeleteProperty$LWS as ReflectDeleteProperty, ReflectGet$LWS as ReflectGet, ReflectGetOwnPropertyDescriptor$LWS as ReflectGetOwnPropertyDescriptor, ReflectGetPrototypeOf$LWS as ReflectGetPrototypeOf, ReflectHas$LWS as ReflectHas, ReflectIsExtensible$LWS as ReflectIsExtensible, ReflectOwnKeys$LWS as ReflectOwnKeys, ReflectPreventExtensions$LWS as ReflectPreventExtensions, ReflectSet$LWS as ReflectSet, ReflectSetPrototypeOf$LWS as ReflectSetPrototypeOf, RegExpCtor$LWS as RegExpCtor, RegExpProto$LWS as RegExpProto, RegExpProtoExec$LWS as RegExpProtoExec, RegExpProtoSourceGetter$LWS as RegExpProtoSourceGetter, RegExpProtoTest$LWS as RegExpProtoTest, SANDBOX_EVAL_CONTEXT_NAME$LWS as SANDBOX_EVAL_CONTEXT_NAME, SANDBOX_EVAL_HELPERS_NAME$LWS as SANDBOX_EVAL_HELPERS_NAME, SUPPORTS_BIG_INT$LWS as SUPPORTS_BIG_INT, SYMBOL_LIVE_OBJECT$LWS as SYMBOL_LIVE_OBJECT, SetCtor$LWS as SetCtor, SetProtoAdd$LWS as SetProtoAdd, SetProtoSizeGetter$LWS as SetProtoSizeGetter, SetProtoValues$LWS as SetProtoValues, StringCtor$LWS as StringCtor, StringProtoCharAt$LWS as StringProtoCharAt, StringProtoCharCodeAt$LWS as StringProtoCharCodeAt, StringProtoEndsWith$LWS as StringProtoEndsWith, StringProtoIncludes$LWS as StringProtoIncludes, StringProtoIndexOf$LWS as StringProtoIndexOf, StringProtoLastIndexOf$LWS as StringProtoLastIndexOf, StringProtoMatch$LWS as StringProtoMatch, StringProtoReplace$LWS as StringProtoReplace, StringProtoSlice$LWS as StringProtoSlice, StringProtoSplit$LWS as StringProtoSplit, StringProtoStartsWith$LWS as StringProtoStartsWith, StringProtoSubstring$LWS as StringProtoSubstring, StringProtoToLowerCase$LWS as StringProtoToLowerCase, StringProtoToUpperCase$LWS as StringProtoToUpperCase, StringProtoValueOf$LWS as StringProtoValueOf, SymbolAsyncIterator$LWS as SymbolAsyncIterator, SymbolFor$LWS as SymbolFor, SymbolIterator$LWS as SymbolIterator, SymbolProtoToString$LWS as SymbolProtoToString, SymbolProtoValueOf$LWS as SymbolProtoValueOf, SymbolToStringTag$LWS as SymbolToStringTag, SymbolUnscopables$LWS as SymbolUnscopables, TO_STRING_BRAND_ARRAY$LWS as TO_STRING_BRAND_ARRAY, TO_STRING_BRAND_ARRAY_BUFFER$LWS as TO_STRING_BRAND_ARRAY_BUFFER, TO_STRING_BRAND_BIG_INT$LWS as TO_STRING_BRAND_BIG_INT, TO_STRING_BRAND_BOOLEAN$LWS as TO_STRING_BRAND_BOOLEAN, TO_STRING_BRAND_DATE$LWS as TO_STRING_BRAND_DATE, TO_STRING_BRAND_ERROR$LWS as TO_STRING_BRAND_ERROR, TO_STRING_BRAND_FUNCTION$LWS as TO_STRING_BRAND_FUNCTION, TO_STRING_BRAND_MAP$LWS as TO_STRING_BRAND_MAP, TO_STRING_BRAND_NULL$LWS as TO_STRING_BRAND_NULL, TO_STRING_BRAND_NUMBER$LWS as TO_STRING_BRAND_NUMBER, TO_STRING_BRAND_OBJECT$LWS as TO_STRING_BRAND_OBJECT, TO_STRING_BRAND_REG_EXP$LWS as TO_STRING_BRAND_REG_EXP, TO_STRING_BRAND_SET$LWS as TO_STRING_BRAND_SET, TO_STRING_BRAND_STRING$LWS as TO_STRING_BRAND_STRING, TO_STRING_BRAND_SYMBOL$LWS as TO_STRING_BRAND_SYMBOL, TO_STRING_BRAND_UNDEFINED$LWS as TO_STRING_BRAND_UNDEFINED, TO_STRING_BRAND_WEAK_MAP$LWS as TO_STRING_BRAND_WEAK_MAP, TO_STRING_BRAND_WEAK_SET$LWS as TO_STRING_BRAND_WEAK_SET, TypeErrorCtor$LWS as TypeErrorCtor, UNCOMPILED_LOCATION_NAME$LWS as UNCOMPILED_LOCATION_NAME, UNCOMPILED_TOP_NAME$LWS as UNCOMPILED_TOP_NAME, WEBPACK_REQUIRE_NAME$LWS as WEBPACK_REQUIRE_NAME, WeakMapCtor$LWS as WeakMapCtor, WeakMapProtoHas$LWS as WeakMapProtoHas, WeakSetCtor$LWS as WeakSetCtor, WeakSetProtoHas$LWS as WeakSetProtoHas, capitalizeFirstChar$LWS as capitalizeFirstChar, clearGaterEnabledFeatures$LWS as clearGaterEnabledFeatures, consoleWarn$LWS as consoleWarn, createRevokedProxy$LWS as createRevokedProxy, createUnmaskableTraps$LWS as createUnmaskableTraps, deregisterGaterEnabledFeatures$LWS as deregisterGaterEnabledFeatures, enquote$LWS as enquote, extractFunctionBodySource$LWS as extractFunctionBodySource, getBrand$LWS as getBrand, getNamespaceMarker$LWS as getNamespaceMarker, getNearMembraneProxySerializedValue$LWS as getNearMembraneProxySerializedValue, getStorageNamespaceMarker$LWS as getStorageNamespaceMarker, getTimestamp$LWS as getTimestamp, getUnmaskedFunction$LWS as getUnmaskedFunction, identity$LWS as identity, indexOfPragma$LWS as indexOfPragma, isAllowedToKeepAlive$LWS as isAllowedToKeepAlive, isAllowedToOverrideGaterEnabledFeature$LWS as isAllowedToOverrideGaterEnabledFeature, isGaterEnabledFeature$LWS as isGaterEnabledFeature, isLockerFeatureEnabled$LWS as isLockerFeatureEnabled, isMaskedFunction$LWS as isMaskedFunction, isNearMembraneProxy$LWS as isNearMembraneProxy, isNotAllowedToOverrideGaterEnabledFeature$LWS as isNotAllowedToOverrideGaterEnabledFeature, isObject$LWS as isObject, isObjectLike$LWS as isObjectLike, isRevokedProxy$LWS as isRevokedProxy, isTargetLive$LWS as isTargetLive, markTargetAsLive$LWS as markTargetAsLive, maskFunction$LWS as maskFunction, noop$LWS as noop, omnistudioPredicates$LWS as omnistudioPredicates, partialStructuredClone$LWS as partialStructuredClone, prependNamespaceMarker$LWS as prependNamespaceMarker, prependStorageNamespaceMarker$LWS as prependStorageNamespaceMarker, registerGaterEnabledFeatures$LWS as registerGaterEnabledFeatures, registerLockerFeature$LWS as registerLockerFeature, removeNamespaceMarker$LWS as removeNamespaceMarker, removeStorageNamespaceMarker$LWS as removeStorageNamespaceMarker, shallowCloneArray$LWS as shallowCloneArray, shallowCloneOptions$LWS as shallowCloneOptions, startsWithNamespaceMarker$LWS as startsWithNamespaceMarker, startsWithStorageNamespaceMarker$LWS as startsWithStorageNamespaceMarker, toRegExpEscapedIdentifierName$LWS as toRegExpEscapedIdentifierName, toRegExpEscapedString$LWS as toRegExpEscapedString, toSafeArray$LWS as toSafeArray, toSafeMap$LWS as toSafeMap, toSafeSet$LWS as toSafeSet, toSafeStringValue$LWS as toSafeStringValue, toSafeTemplateStringValue$LWS as toSafeTemplateStringValue, toSafeWeakMap$LWS as toSafeWeakMap, toSafeWeakSet$LWS as toSafeWeakSet, trackAsLiveTarget$LWS as trackAsLiveTarget };
/*! version: 0.24.6 */
