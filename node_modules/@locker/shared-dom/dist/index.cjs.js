...
function normalizeNamespacedAttributeName$LWS(attrName$LWS) {
  ...
  if (shared$LWS.ReflectApply(shared$LWS.StringProtoEndsWith, attrName$LWS, [href$LWS]) &&
  // ...But we don't want to match "xlink:href"
  !shared$LWS.ReflectApply(shared$LWS.StringProtoStartsWith, attrName$LWS, ['xlink:href'])) {
    return href$LWS;
  }
  return attrName$LWS;
}
...
function initWindowOpenChildWindow$LWS(win$LWS, url$LWS) {
  ...
  if (typeof url$LWS === 'string' && url$LWS !== '') {
    ...
    // window.
    try {
      const doc$LWS = shared$LWS.ReflectApply(WindowDocumentGetter$LWS, win$LWS, []);
      ...
      if (location$LWS.href !== url$LWS) {
        ...
        // redirect behavior.
        shared$LWS.ReflectApply(DocumentProtoOpen$LWS, doc$LWS, []);
        shared$LWS.ReflectApply(DocumentProtoClose$LWS, doc$LWS, []);
...
function normalizeWindowOpenArguments$LWS(args$LWS) {
  const normalizedArgs$LWS = shared$LWS.shallowCloneArray(args$LWS);
  const {
    length: length$LWS
  } = normalizedArgs$LWS;
  if (length$LWS) {
  ...
  if (length$LWS > 2) {
    ...
    if (features$LWS) {
      ...
      let loweredFeatures$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoToLowerCase, features$LWS, []);
      // RegExp.prototype[Symbol.replace] resets the lastIndex of global
      // regexp to 0.
      // https://tc39.es/ecma262/#sec-regexp.prototype-@@replace
      if (shared$LWS.ReflectApply(shared$LWS.RegExpProtoTest, noopenerRegExp$LWS, [loweredFeatures$LWS])) {
        ...
        loweredFeatures$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoReplace, loweredFeatures$LWS, [
...
const HTMLElementProtoInnerTextGetter$LWS = shared$LWS.ObjectLookupOwnGetter(HTMLElementProto$LWS, 'innerText');
// Used by '@locker/near-membrane-dom'.
...
const NodeProtoIsConnectedGetter$LWS = shared$LWS.ObjectLookupOwnGetter(NodeProto$LWS, 'isConnected');
// Used by '@locker/near-membrane-dom'.
...
const NodeProtoParentNodeGetter$LWS = shared$LWS.ObjectLookupOwnGetter(NodeProto$LWS, 'parentNode');
const {
...
const rootDocumentDetachedFragment$LWS = shared$LWS.ReflectApply(DocumentProtoCreateDocumentFragment$LWS, rootDocument$LWS, []);
const rootDocumentDetachedContainer$LWS = shared$LWS.ReflectApply(DocumentProtoCreateElement$LWS, rootDocument$LWS, ['div']);
...
class Validator$LWS {
  constructor(document$LWS, {
    ...
    this.isInherentlyUnsecure = input$LWS => {
      ...
      // check useless.
      shared$LWS.ReflectApply(DocumentFragmentProtoAppend$LWS, rootDocumentDetachedFragment$LWS, [rootDocumentDetachedContainer$LWS]);
      shared$LWS.ReflectApply(ElementProtoInnerHTMLSetter$LWS, rootDocumentDetachedContainer$LWS, [input$LWS]);
      ...
      const innerHTML$LWS = shared$LWS.ReflectApply(ElementProtoInnerHTMLGetter$LWS, rootDocumentDetachedContainer$LWS, []);
      const innerText$LWS = shared$LWS.ReflectApply(HTMLElementProtoInnerTextGetter$LWS, rootDocumentDetachedContainer$LWS, []);
      shared$LWS.ReflectApply(ElementProtoRemove$LWS, rootDocumentDetachedContainer$LWS, []);
...
const CUSTOM_ELEMENT_REGISTRY_ATTRIBUTE_NAME$LWS = shared$LWS.LOCKER_SERVICE_KEY_LOWERED;
// Used by '@locker/near-membrane-dom'.
...
shared$LWS.ArrayIsArray(brands$LWS) && brands$LWS.length ?
...
shared$LWS.ReflectApply(shared$LWS.ArrayProtoFind, brands$LWS, [
// prettier-ignore
// istanbul ignore next: this code is not reachable in the coverage run.
...
// istanbul ignore next: this code is not reachable in the coverage run.
shared$LWS.ArrayIsArray(brands$LWS) && brands$LWS.length ? shared$LWS.ReflectApply(shared$LWS.ArrayProtoFind, brands$LWS, [
...
const DOMTokenListProtoLengthGetter$LWS = shared$LWS.ObjectLookupOwnGetter(DOMTokenListProto$LWS, 'length');
const DOMTokenListProtoValueGetter$LWS = shared$LWS.ObjectLookupOwnGetter(DOMTokenListProto$LWS, 'value');
...
const HTMLIFrameElementProtoSandboxGetter$LWS = shared$LWS.ObjectLookupOwnGetter(HTMLIFrameElementProto$LWS, 'sandbox');
const HTMLIFrameElementProtoSandboxSetter$LWS = shared$LWS.ObjectLookupOwnSetter(HTMLIFrameElementProto$LWS, 'sandbox');
const HTMLIFrameElementProtoSrcGetter$LWS = shared$LWS.ObjectLookupOwnGetter(HTMLIFrameElementProto$LWS, 'src');
...
const URLProtoOriginGetter$LWS = shared$LWS.ObjectLookupOwnGetter(URLCtor$LWS.prototype, 'origin');
const {
...
const originalScriptPropertyCache$LWS = shared$LWS.toSafeWeakMap(new shared$LWS.WeakMapCtor());
...
function defineScriptEvaluatorProperty$LWS(script$LWS, callback$LWS) {
  ...
  if (!shared$LWS.ReflectDefineProperty(script$LWS, SCRIPT_EVALUATOR_PROPERTY_NAME$LWS, {
    ...
    get: shared$LWS.ReflectApply(shared$LWS.FunctionProtoBind, () => {
      ...
      const defaultView$LWS = shared$LWS.ReflectApply(DocumentProtoDefaultViewGetter$LWS, ownerDoc$LWS, []);
...
class Tokenizer$LWS {
  ...
  currentCharCode() {
    return shared$LWS.ReflectApply(shared$LWS.StringProtoCharCodeAt, this.source, [this.currIndex]);
  }
  ...
  lookAhead() {
    return shared$LWS.ReflectApply(shared$LWS.StringProtoCharCodeAt, this.source, [this.currIndex + 1]);
  }
  nextCharCode() {
    return shared$LWS.ReflectApply(shared$LWS.StringProtoCharCodeAt, this.source, [++this.currIndex]);
  }
...
class Transpiler$LWS {
  ...
  constructor(memberProperties$LWS) {
    ...
    const regexString$LWS = shared$LWS.ReflectApply(shared$LWS.ArrayProtoJoin, regexParts$LWS, ['|']);
    this.memberExprPatt = new shared$LWS.RegExpCtor(regexString$LWS, 'g');
  ...
  compile(input$LWS) {
    ...
    let match$LWS = shared$LWS.ReflectApply(shared$LWS.RegExpProtoExec, this.memberExprPatt, [input$LWS]);
    while (match$LWS) {
      const stringSliceToMachedIndex$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoSubstring, input$LWS, [currentIndex$LWS, match$LWS.index]);
      ...
      if (property$LWS === 'location' && this.tokenizer.getPreviousToken(propertyIndex$LWS, input$LWS).type === 6 /* TokenType.TOP */) {
        ...
        if (parent$LWS.type === 3 /* TokenType.MEMBER_OBJECT */) {
          const parentObj$LWS = shared$LWS.ReflectApply(shared$LWS.StringProtoSlice, input$LWS, [match$LWS.index, match$LWS.index + parent$LWS.value.length]);
    ...
    if (currentIndex$LWS < input$LWS.length) {
      compiledOutput$LWS += shared$LWS.ReflectApply(shared$LWS.StringProtoSubstring, input$LWS, [currentIndex$LWS, input$LWS.length]);
    }
  ...
  trimEndingChar(input$LWS) {
    return shared$LWS.ReflectApply(shared$LWS.StringProtoSlice, input$LWS, [0, -1]);
  }
...
function createPropertyReferenceRegExp$LWS(objectPattern$LWS, key$LWS) {
  ...
  //     *= /= %= += -= <<= >>= >>>= &= ^= |= **=
  return new shared$LWS.RegExpCtor(`\\b(?:${objectPattern$LWS})\\.${key$LWS}\\b(\\s*(?:[?*/%&^|+-]|>>>?|<<)*=(?=[^=]))?`, 'g');
}
...
} = shared$LWS.ReflectGetOwnPropertyDescriptor(SVGScriptElement.prototype, 'href');
...
exports.DOMTokenListProtoAdd = DOMTokenListProtoAdd$LWS;
exports.DOMTokenListProtoContains = DOMTokenListProtoContains$LWS;
exports.DOMTokenListProtoLengthGetter = DOMTokenListProtoLengthGetter$LWS;
exports.DOMTokenListProtoRemove = DOMTokenListProtoRemove$LWS;
exports.DOMTokenListProtoValueGetter = DOMTokenListProtoValueGetter$LWS;
exports.DocumentFragmentProtoAppend = DocumentFragmentProtoAppend$LWS;
...
exports.DocumentProtoCreateDocumentFragment = DocumentProtoCreateDocumentFragment$LWS;
...
exports.ElementAriaAttributesToPropertyName = ElementAriaAttributesToPropertyName$LWS;
...
exports.HTMLElementGlobalAttributesToPropertyName = HTMLElementGlobalAttributesToPropertyName$LWS;
exports.HTMLElementProto = HTMLElementProto$LWS;
exports.HTMLElementProtoInnerTextGetter = HTMLElementProtoInnerTextGetter$LWS;
...
exports.HTMLIFrameElementProtoSandboxGetter = HTMLIFrameElementProtoSandboxGetter$LWS;
exports.HTMLIFrameElementProtoSandboxSetter = HTMLIFrameElementProtoSandboxSetter$LWS;
exports.HTMLIFrameElementProtoSrcGetter = HTMLIFrameElementProtoSrcGetter$LWS;
...
exports.NodeProtoParentNodeGetter = NodeProtoParentNodeGetter$LWS;
...
exports.Transpiler = Transpiler$LWS;
exports.UNIVERSAL_CONTEXT_NAMES = UNIVERSAL_CONTEXT_NAMES$LWS;
exports.URLCreateObjectURL = URLCreateObjectURL$LWS;
exports.URLCtor = URLCtor$LWS;
exports.URLProtoOriginGetter = URLProtoOriginGetter$LWS;
...
exports.deleteOriginalScriptProperty = deleteOriginalScriptProperty$LWS;
...
exports.initWindowOpenChildWindow = initWindowOpenChildWindow$LWS;
exports.isScriptEvaluated = isScriptEvaluated$LWS;
exports.isScriptPropertyEvaluatorHookDefined = isScriptPropertyEvaluatorHookDefined$LWS;
...
exports.normalizeWindowOpenArguments = normalizeWindowOpenArguments$LWS;
...
exports.setOriginalScriptScriptProperty = setOriginalScriptScriptProperty$LWS;
