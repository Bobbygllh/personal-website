 ...
 */
import { toSafeWeakMap as toSafeWeakMap$1$LWS, WeakMapCtor as WeakMapCtor$1$LWS, toSafeMap as toSafeMap$1$LWS, MapCtor as MapCtor$1$LWS, ReflectDefineProperty as ReflectDefineProperty$1$LWS, ReflectApply as ReflectApply$1$LWS, ObjectKeys as ObjectKeys$1$LWS, toSafeSet as toSafeSet$LWS, SetCtor as SetCtor$1$LWS, ObjectPreventExtensions as ObjectPreventExtensions$LWS, ObjectFreeze as ObjectFreeze$1$LWS, LOCKER_UNMINIFIED_FLAG as LOCKER_UNMINIFIED_FLAG$1$LWS, ReflectConstruct as ReflectConstruct$LWS, ReflectGetOwnPropertyDescriptor as ReflectGetOwnPropertyDescriptor$LWS, ArrayConcat as ArrayConcat$LWS, maskFunction as maskFunction$LWS, UNCOMPILED_LOCATION_NAME as UNCOMPILED_LOCATION_NAME$LWS, UNCOMPILED_TOP_NAME as UNCOMPILED_TOP_NAME$LWS, SANDBOX_EVAL_CONTEXT_NAME as SANDBOX_EVAL_CONTEXT_NAME$LWS, SANDBOX_EVAL_HELPERS_NAME as SANDBOX_EVAL_HELPERS_NAME$LWS, noop as noop$1$LWS, ObjectLookupOwnGetter as ObjectLookupOwnGetter$1$LWS, ObjectLookupOwnSetter as ObjectLookupOwnSetter$LWS, PromiseCtor as PromiseCtor$LWS, TypeErrorCtor as TypeErrorCtor$1$LWS, PromiseProtoThen as PromiseProtoThen$LWS, toSafeStringValue as toSafeStringValue$LWS, PromiseResolve as PromiseResolve$LWS, PromiseReject as PromiseReject$LWS, enquote as enquote$LWS, SymbolAsyncIterator as SymbolAsyncIterator$LWS, SymbolIterator as SymbolIterator$1$LWS, extractFunctionBodySource as extractFunctionBodySource$LWS, StringProtoReplace as StringProtoReplace$LWS, indexOfPragma as indexOfPragma$LWS, toSafeWeakSet as toSafeWeakSet$1$LWS, WeakSetCtor as WeakSetCtor$1$LWS, ReflectOwnKeys as ReflectOwnKeys$1$LWS, LockerSecurityError as LockerSecurityError$LWS, ERR_INVALID_SANDBOX_KEY as ERR_INVALID_SANDBOX_KEY$LWS, isGaterEnabledFeature as isGaterEnabledFeature$LWS, ENABLE_MAX_PERF_MODE_GATE as ENABLE_MAX_PERF_MODE_GATE$LWS, isAllowedToOverrideGaterEnabledFeature as isAllowedToOverrideGaterEnabledFeature$LWS, isAllowedToKeepAlive as isAllowedToKeepAlive$LWS, isLockerFeatureEnabled as isLockerFeatureEnabled$LWS, ObjectHasOwn as ObjectHasOwn$1$LWS, ObjectAssign as ObjectAssign$1$LWS, ObjectGetOwnPropertyDescriptors as ObjectGetOwnPropertyDescriptors$LWS, isTargetLive as isTargetLive$LWS, toSafeArray as toSafeArray$1$LWS, StringProtoToLowerCase as StringProtoToLowerCase$LWS, FunctionProtoToString as FunctionProtoToString$LWS } from '@locker/shared';
import { rootDocument as rootDocument$LWS, rootWindow as rootWindow$1$LWS, IS_WEBKIT_BROWSER as IS_WEBKIT_BROWSER$LWS, CHILD_WINDOW_BLOCKED_PROPERTY_SYMBOL as CHILD_WINDOW_BLOCKED_PROPERTY_SYMBOL$LWS, rootWindowLocation as rootWindowLocation$LWS, rootWindowTop as rootWindowTop$LWS, HTMLScriptElementProtoSrcGetter as HTMLScriptElementProtoSrcGetter$LWS, HTMLScriptElementProtoSrcSetter as HTMLScriptElementProtoSrcSetter$LWS, ElementProtoQuerySelectorAll as ElementProtoQuerySelectorAll$LWS, DocumentProtoCreateElement as DocumentProtoCreateElement$1$LWS, ElementProtoQuerySelector as ElementProtoQuerySelector$LWS, EventTargetProtoAddEventListener as EventTargetProtoAddEventListener$LWS, NodeProtoAppendChild as NodeProtoAppendChild$1$LWS, EventTargetProtoRemoveEventListener as EventTargetProtoRemoveEventListener$LWS, EventProtoStopPropagation as EventProtoStopPropagation$LWS, WindowFrameElementGetter as WindowFrameElementGetter$LWS, WindowQueueMicrotask as WindowQueueMicrotask$LWS, WindowDocumentGetter as WindowDocumentGetter$LWS, WindowLocationGetter as WindowLocationGetter$LWS, DocumentProtoDefaultViewGetter as DocumentProtoDefaultViewGetter$LWS } from '@locker/shared-dom';
import { internalDistortionFactoryInitializers as internalDistortionFactoryInitializers$LWS, internalKeyedDistortionFactoryInitializers as internalKeyedDistortionFactoryInitializers$LWS, externalDistortionFactoryInitializers as externalDistortionFactoryInitializers$LWS, externalKeyedDistortionFactoryInitializers as externalKeyedDistortionFactoryInitializers$LWS, addBlockedAttributeDistortionFactoryInitializers as addBlockedAttributeDistortionFactoryInitializers$LWS, HTMLElementBlockedAttributes as HTMLElementBlockedAttributes$LWS, HTMLIFrameElementBlockedAttributes as HTMLIFrameElementBlockedAttributes$LWS, HTMLScriptElementBlockedAttributes as HTMLScriptElementBlockedAttributes$LWS, SVGElementBlockedAttributes as SVGElementBlockedAttributes$LWS, addBlockedPropertyDistortionFactoryInitializers as addBlockedPropertyDistortionFactoryInitializers$LWS, DataTransferBlockedProperties as DataTransferBlockedProperties$LWS, DocumentBlockedProperties as DocumentBlockedProperties$LWS, ElementBlockedProperties as ElementBlockedProperties$LWS, EventBlockedProperties as EventBlockedProperties$LWS, HTMLElementBlockedProperties as HTMLElementBlockedProperties$LWS, HTMLIFrameElementBlockedProperties as HTMLIFrameElementBlockedProperties$LWS, HTMLEmbedElementBlockedProperties as HTMLEmbedElementBlockedProperties$LWS, HTMLObjectElementBlockedProperties as HTMLObjectElementBlockedProperties$LWS, HTMLScriptElementBlockedProperties as HTMLScriptElementBlockedProperties$LWS, SVGElementBlockedProperties as SVGElementBlockedProperties$LWS, UIEventBlockedProperties as UIEventBlockedProperties$LWS, WindowBlockedProperties as WindowBlockedProperties$LWS, XSLTProcessorBlockedProperties as XSLTProcessorBlockedProperties$LWS, patchGlobalObject as patchGlobalObject$LWS, distortionFactoryInitializerToggleSwitches as distortionFactoryInitializerToggleSwitches$LWS, finalizeAttributeDistortions as finalizeAttributeDistortions$LWS, initDistortionWindowPostMessage as initDistortionWindowPostMessage$LWS } from '@locker/distortion';
...
import { sanitizeSvgHref as sanitizeSvgHref$LWS } from '@locker/html-sanitizer';
const rootSandboxRegistry$LWS = {
  __proto__: null
};
const documentSandboxRegistryCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS([[rootDocument$LWS, rootSandboxRegistry$LWS]]));
const opaqueWindowSandboxRegistryCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
...
const ENABLE_DISTORTION_TOGGLE_SWITCHES$LWS = LOCKER_UNMINIFIED_FLAG$1$LWS || /* istanbul ignore next */false || /* istanbul ignore next */false;
const distortionFactoryToToggleSwitch$LWS = ENABLE_DISTORTION_TOGGLE_SWITCHES$LWS ? toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS()) : /* istanbul ignore next */null;
const sandboxToDistortionEntryToToggleSwitchRegistry$LWS = ENABLE_DISTORTION_TOGGLE_SWITCHES$LWS ? toSafeWeakMap$1$LWS(
// The value must be a Map because its entries are iterated over in lws.ts
new WeakMapCtor$1$LWS()) : /* istanbul ignore next */null;
const sandboxToDisabledDistortionToggleSwitches$LWS = toSafeMap$1$LWS(new MapCtor$1$LWS());
...
if (ENABLE_DISTORTION_TOGGLE_SWITCHES$LWS) {
  ReflectDefineProperty$1$LWS(LightningWebSecurity$LWS, 'namespaces', {
    __proto__: null,
    enumerable: true,
    configurable: false,
    get() {
      ...
      if (!namespaces$LWS) {
        ...
        const sandboxKeys$LWS = ReflectApply$1$LWS(ObjectKeys$1$LWS, null, [registry$LWS]);
        ...
        for (const sandboxKey$LWS of sandboxKeys$LWS) {
          ...
          const seenFlags$LWS = toSafeSet$LWS(new SetCtor$1$LWS());
          ...
          for (const {
            ...
            if (!seenFlags$LWS.has(flag$LWS)) {
              ...
              ReflectDefineProperty$1$LWS(namespaces$LWS[sandboxKey$LWS].distortions, flag$LWS, {
                __proto__: null,
                enumerable: true,
                configurable: false,
                get() {
  ...
  ReflectDefineProperty$1$LWS(window, '$LWS', {
    __proto__: null,
    enumerable: false,
    configurable: false,
    writable: false,
...
ObjectFreeze$1$LWS(LightningWebSecurity$LWS);
...
function createDistortionToggleSwitchWrapper$LWS(sandboxKey$LWS, toggleSwitchName$LWS, proxyMaskedFunctionDistortion$LWS, originalValue$LWS) {
  ...
  return function (...args$LWS) {
    ...
    return ReflectApply$1$LWS(constructOrApplyTarget$LWS, this, args$LWS);
  };
}
const distortionFactoriesCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
const opaqueWindowPostMessageDistortionFactoryCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
...
function createDistortionEntries$LWS(record$LWS, factories$LWS) {
  const distortionEntryToToggleSwitch$LWS = toSafeMap$1$LWS(new MapCtor$1$LWS());
  const entries$LWS = [];
  for (let i$LWS = 0, {
      length: length$LWS
      ...
      if (typeof originalValue$LWS === 'function') {
        ...
        if (ENABLE_DISTORTION_TOGGLE_SWITCHES$LWS && toggleSwitchName$LWS) {
          ...
          if (originalValue$LWS[CHILD_WINDOW_BLOCKED_PROPERTY_SYMBOL$LWS]) {
            ...
            ReflectDefineProperty$1$LWS(distortionToggleSwitchWrapperOrProxyMaskedFunction$LWS, CHILD_WINDOW_BLOCKED_PROPERTY_SYMBOL$LWS, descriptor$LWS);
          }
        }
  ...
  if (ENABLE_DISTORTION_TOGGLE_SWITCHES$LWS) {
    ...
    sandboxToDisabledDistortionToggleSwitches$LWS.set(record$LWS, toSafeSet$LWS(new SetCtor$1$LWS()));
  }
  return entries$LWS;
}
function createDistortionMap$LWS(entries$LWS) {
  return SUPPORTS_DISTORTIONS_WEAK_MAP$LWS ? toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS(entries$LWS)) :
  // istanbul ignore next: this code is not reachable in the coverage run.
  toSafeMap$1$LWS(new MapCtor$1$LWS(entries$LWS));
}
...
function proxyMaskFunctionDistortion$LWS({
  ...
  return maskFunction$LWS(distortionFunc$LWS, maskFunc$LWS, {
    apply: function (target$LWS, thisArg$LWS, args$LWS) {
      ...
      try {
        return ReflectApply$1$LWS(target$LWS, thisArg$LWS, args$LWS);
      } catch (error) {
...
function createEvalHelpersFactoryArgs$LWS(record$LWS) {
  ...
  const forOfStateCache$LWS = toSafeMap$1$LWS(new MapCtor$1$LWS());
  const resourcePromiseCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
  const resourceStatusCache$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
  const scriptSrcGetterDistortion$LWS = distortions$LWS.get(isRootRecord$LWS ? HTMLScriptElementProtoSrcGetter$LWS : ObjectLookupOwnGetter$1$LWS(HTMLScriptElementProto$LWS, 'src'));
  ...
  function genStep$LWS(resolve$LWS, reject$LWS, next$LWS, thrower$LWS, genMethodWrapper$LWS, arg$LWS) {
    ...
    if (info$LWS.done) {
      ...
      ReflectApply$1$LWS(PromiseProtoThen$LWS, PromiseResolve$LWS(value$LWS), [next$LWS, thrower$LWS]);
    }
  }
  // istanbul ignore next: currently unreachable via tests, platformResourceLoader testing is exclusively done in AMD format mode
  function loadPromise$LWS(element$LWS, urlAsString$LWS) {
    const promise$LWS = new PromiseCtor$LWS((resolve$LWS, reject$LWS) => {
      function onerror$LWS(event$LWS) {
        ReflectApply$1$LWS(EventTargetProtoRemoveEventListener$LWS, element$LWS, ['error', onerror$LWS]);
        ReflectApply$1$LWS(EventTargetProtoRemoveEventListener$LWS, element$LWS, ['load', onload$LWS]);
        ReflectApply$1$LWS(EventProtoStopPropagation$LWS, event$LWS, []);
      ...
      ReflectApply$1$LWS(EventTargetProtoAddEventListener$LWS, element$LWS, ['error', onerror$LWS]);
      ReflectApply$1$LWS(EventTargetProtoAddEventListener$LWS, element$LWS, ['load', onload$LWS]);
    });
    ...
    ReflectApply$1$LWS(NodeProtoAppendChild$1$LWS, head$LWS, [element$LWS]);
    return promise$LWS;
  }
  return [
  ...
  function forAwaitOf$LWS(index$LWS, stage$LWS, object$LWS) {
    if (stage$LWS === 0 /* init */) {
      ...
      if (iterator$LWS === null || iterator$LWS === undefined) {
        sync$LWS = true;
        ({
          [SymbolIterator$1$LWS]: iterator$LWS
        } = object$LWS);
      }
      if (typeof iterator$LWS !== 'function') {
        throw new TypeErrorCtor$1$LWS('Object is not async iterable');
      }
      forOfStateCache$LWS.set(index$LWS, {
        iterable: ReflectApply$1$LWS(iterator$LWS, object$LWS, []),
        step: undefined,
        sync: sync$LWS
      });
      return undefined;
    ...
    if (stage$LWS === 1 /* step */) {
      ...
      return state$LWS.sync ? new PromiseCtor$LWS(resolve$LWS => {
        ...
        resolve$LWS();
      }) : ReflectApply$1$LWS(PromiseProtoThen$LWS, result$LWS, [step$LWS => {
  ...
  function loadScript$LWS(_thisArg$LWS, url$LWS) {
    ...
    const scripts$LWS = ReflectApply$1$LWS(ElementProtoQuerySelectorAll$LWS, head$LWS, ['script']);
    for (let i$LWS = 0, {
        length: length$LWS
      ...
      // istanbul ignore else: current tests have no way of expressing a state that would cause this condition to evaluate false
      if (status$LWS && ReflectApply$1$LWS(scriptSrcGetterDistortion$LWS, script$LWS, []) === urlResolved$LWS) {
    ...
    const script$LWS = ReflectApply$1$LWS(DocumentProtoCreateElement$1$LWS, document$LWS, ['script']);
    ...
    ReflectApply$1$LWS(scriptSrcSetterDistortion$LWS, script$LWS, [urlResolved$LWS]);
  ...
  function loadStyle$LWS(_thisArg$LWS, url$LWS) {
    const urlResolved$LWS = resolveURL$LWS(toSafeStringValue$LWS(url$LWS));
    let link$LWS = ReflectApply$1$LWS(ElementProtoQuerySelector$LWS, head$LWS, [`link[href=${enquote$LWS(urlResolved$LWS)}]`]);
    if (link$LWS) {
    ...
    link$LWS = ReflectApply$1$LWS(DocumentProtoCreateElement$1$LWS, document$LWS, ['link']);
...
function toSourceText$LWS(value$LWS, sourceType$LWS) {
  ...
  sourceText$LWS = ReflectApply$1$LWS(StringProtoReplace$LWS, sourceText$LWS, [
...
const IFRAME_KEEP_ALIVE_FLAG$LWS = LOCKER_UNMINIFIED_FLAG$1$LWS && !false;
...
const rootDistortionMapSeedEntries$LWS = [[rootDocument$LWS, rootDocument$LWS], [rootWindowLocation$LWS, rootWindowLocation$LWS], [rootWindow$1$LWS, rootWindow$1$LWS]];
const seenGlobalObjects$LWS = toSafeWeakSet$1$LWS(new WeakSetCtor$1$LWS());
  ...
  return sourceText$LWS => {
    ...
    if (virtualEnvironment$LWS === undefined) {
      ...
      setEvalContext$LWS(redEvalHelpersFactory$LWS => {
        const helpers$LWS = ReflectApply$1$LWS(redEvalHelpersFactory$LWS, undefined, createEvalHelpersFactoryArgs$LWS(record$LWS));
      ...
      if (typeof context$LWS === 'object' && context$LWS !== null) {
        ...
        const ownKeys$LWS = ReflectOwnKeys$1$LWS(context$LWS);
        for (let i$LWS = 0, {
            length: length$LWS
          } = ownKeys$LWS; i$LWS < length$LWS; i$LWS += 1) {
...
function createVirtualEnvironment$LWS(record$LWS) {
  ...
  return createIframeVirtualEnvironment$LWS(globalObject$LWS, {
    ...
    distortionCallback(originalTarget$LWS) {
      ...
      if (ObjectHasOwn$1$LWS(originalTarget$LWS, 'window') && originalTarget$LWS.window === originalTarget$LWS) {
        ...
        try {
          ...
          defaultView$LWS = ReflectApply$1$LWS(DocumentProtoDefaultViewGetter$LWS, originalTarget$LWS, []);
          // eslint-disable-next-line no-empty
        } catch (_unused39$LWS) {}
        if (defaultView$LWS) {
    ...
    signSourceCallback: sourceText$LWS => trusted$LWS.createScript(sourceText$LWS)
  });
}
// istanbul ignore next: currently unreachable via tests
...
function createSecondaryWindowSandboxRecord$LWS({
  ...
  const frameElement$LWS = ReflectApply$1$LWS(WindowFrameElementGetter$LWS, globalObject$LWS, []);
  if (frameElement$LWS) {
    // Create a new sandbox record when the iframe window location changes.
    ReflectApply$1$LWS(EventTargetProtoAddEventListener$LWS, frameElement$LWS, ['load', onDOMContentLoadedOrWindowLoad$LWS,
    // useCapture
    true]);
  } else {
    ...
    ReflectApply$1$LWS(EventTargetProtoAddEventListener$LWS, globalObject$LWS, ['unload', function onWindowUnload$LWS() {
      WindowQueueMicrotask$LWS(() => {
        try {
          ...
          // istanbul ignore next: currently unreachable via tests
          ReflectApply$1$LWS(EventTargetProtoAddEventListener$LWS, globalObject$LWS, ['DOMContentLoaded', onDOMContentLoadedOrWindowLoad$LWS, true]);
          // istanbul ignore next: currently unreachable via tests
          ReflectApply$1$LWS(EventTargetProtoAddEventListener$LWS, globalObject$LWS, ['unload', onWindowUnload$LWS, true]);
        } catch (_unused41$LWS) {
          // istanbul ignore next: this is a safety precaution that is unreachable via tests
          createOpaqueSecondaryWindowSandboxRecord$LWS({
            globalObject: globalObject$LWS,
...
function internalEvaluateInSandbox$LWS(evaluateOptions$LWS) {
  ...
  } = globalObject$LWS === rootWindow$1$LWS ? createRootWindowSandboxRecord$LWS({
    context: context$LWS,
    endowments: endowments$LWS,
    instrumentation: instrumentation$LWS,
    key: key$LWS,
...
function evaluateFunction$LWS(key$LWS, fn$LWS, scope$LWS = EMPTY_OBJECT$LWS, sourceURL$LWS = '', endowments$LWS = EMPTY_OBJECT$LWS, instrumentation$LWS = EMPTY_OBJECT$LWS, verboseInstrumentation$LWS = false) {
  const argValues$LWS = toSafeArray$1$LWS([rootWindow$1$LWS.location, rootWindow$1$LWS.top]);
  const argNames$LWS = toSafeArray$1$LWS(['location', 'top']);
  const providedScopeNames$LWS = ObjectKeys$1$LWS(scope$LWS);
  for (let i$LWS = 0, {
      length: length$LWS
...
const sandboxDependencies$LWS = toSafeMap$1$LWS(new MapCtor$1$LWS());
const lprDepNames$LWS = toSafeSet$LWS(new SetCtor$1$LWS(['lightning/platformResourceLoader', 'lightning:platformResourceLoader', 'lightningmobileruntime/platformResourceLoader', 'lightningmobileruntime:platformResourceLoader']));
// istanbul ignore next: currently unreachable via tests, platformResourceLoader testing is exclusively done in AMD format mode
...
function wrapLWC$LWS(dep$LWS, key$LWS) {
  ...
  if (depRegistry$LWS === undefined) {
    depRegistry$LWS = toSafeWeakMap$1$LWS(new WeakMapCtor$1$LWS());
  ...
  secureDep$LWS = ObjectAssign$1$LWS({}, dep$LWS);
  ReflectDefineProperty$1$LWS(secureDep$LWS, 'sanitizeAttribute', {
    __proto__: null,
    enumerable: true,
    configurable: true,
    writable: true,
    value(tag$LWS, _namespace$LWS, attrName$LWS, attrValue$LWS) {
      if ((attrName$LWS === 'href' || attrName$LWS === 'xlink:href') && ReflectApply$1$LWS(StringProtoToLowerCase$LWS, tag$LWS, []) === 'use') {
        return sanitizeSvgHref$LWS(attrValue$LWS);
      }
      return attrValue$LWS;
    }
  });
  ReflectDefineProperty$1$LWS(secureDep$LWS, 'renderer', {
    __proto__: null,
    enumerable: true,
    configurable: true,
    get: function () {
        ...
        if (renderer$LWS === undefined) {
          renderer$LWS = createRootWindowSandboxRecord$LWS({
            key: key$LWS
                    ...
                    (${ReflectApply$1$LWS(FunctionProtoToString$LWS, dep$LWS.rendererFactory, [])})`)(dep$LWS.renderer);
        }
        return renderer$LWS;
      };
    }(),
...
export { $LWS, CORE_SANDBOX_KEY$LWS as CORE_SANDBOX_KEY, createRootWindowSandboxRecord$LWS as createRootWindowSandboxRecord, evaluateFunction$LWS as evaluateFunction, evaluateInCoreSandbox$LWS as evaluateInCoreSandbox, evaluateInSandbox$LWS as evaluateInSandbox, wrapDependency$LWS as wrapDependency };
/*! version: 0.24.6 */
