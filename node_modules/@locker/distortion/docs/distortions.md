...
- [AbstractRange.prototype.endContainer getter](#abstractrangeprototypeendcontainer-getter)
  - [Distorted Behavior](#distorted-behavior)
- [AbstractRange.prototype.startContainer getter](#abstractrangeprototypestartcontainer-getter)
...
- [Document.prototype.requestStorageAccess](#documentprototyperequeststorageaccess)
...
- [Element.prototype.setHTMLUnsafe](#elementprototypesethtmlunsafe-1)
...
- [HTMLElement "securitypolicyviolation" event](#htmlelement-securitypolicyviolation-event)
...
- [HTMLIFrameElement.prototype.sandbox getter](#htmliframeelementprototypesandbox-getter)
  - [Distorted Behavior](#distorted-behavior-73)
- [HTMLIFrameElement.prototype.sandbox setter](#htmliframeelementprototypesandbox-setter)
...
- [MathMLElement "securitypolicyviolation" event](#mathmlelement-securitypolicyviolation-event)
...
- [ShadowRoot.prototype.setHTMLUnsafe](#shadowrootprototypesethtmlunsafe)
...
<hr>
<a name="abstractrangedocsstartcontainer-gettermd"></a>
...
<hr>
<a name="documentdocsblocked-properties-requeststorageaccess-valuemd"></a>
...
The event is fired on the element that violates the policy and bubbles. It is normally handled by an event handler on the `Element`, `Document` or `Window` object.
...
This distortion sanitizes and prevents HTML from replacing the DOM within shared `<head>` and `<body>` elements.
<hr>
<a name="elementdocssethtmlunsafe-valuemd"></a>
...
<hr>
<a name="htmlelementdocsonsecuritypolicyviolation-settermd"></a>

## HTMLElement "securitypolicyviolation" event
...
<hr>
<a name="htmliframeelementdocssandbox-gettermd"></a>
...
<hr>
<a name="htmliframeelementdocssandbox-settermd"></a>
...
<hr>
<a name="mathmlelementdocsonsecuritypolicyviolation-settermd"></a>

## MathMLElement "securitypolicyviolation" event
...
<hr>
<a name="shadowrootdocssethtmlunsafe-valuemd"></a>
