...
function initDistortionDocumentOpen$LWS({
  ...
  const distortionEntry$LWS = [originalDocumentOpen$LWS, function open$LWS(...args$LWS) {
    ...
    if (length$LWS >= 3) {
      ...
      if (shared$LWS.isGaterEnabledFeature('enabledChangesSince.256')) {
        ...
        if (sharedUrl$LWS.isSameOriginURL(resourceUrl$LWS)) {
          // W-16032332
      ...
      if (childWindow$LWS) {
        sharedDom$LWS.initWindowOpenChildWindow(childWindow$LWS, resourceUrl$LWS);
      }
...
function enforceSandboxAllowScriptsForSameOriginIframeRealm$LWS(iframe$LWS) {
  ...
  if (srcValue$LWS !== '' && srcValue$LWS !== ABOUT_BLANK_TOKEN$LWS) {
    ...
    try {
      ...
      if (!sharedUrl$LWS.isSameOriginURL(srcValue$LWS)) {
        return;
      }
    } catch (_unused2$LWS) {
      /* empty */
...
function initDistortionHTMLScriptElementTextContentGetter$LWS({
  ...
  const descriptor$LWS = shared$LWS.ReflectGetOwnPropertyDescriptor(HTMLScriptElement$LWS.prototype, 'textContent');
  // This may not be implemented in all browsers.
  // https://www.w3.org/TR/trusted-types/#enforcement-in-scripts
  if (!shared$LWS.isGaterEnabledFeature('enabledChangesSince.256') || !descriptor$LWS) {
    return shared$LWS.noop;
  }
...
function initDistortionNodeTextContentGetter$LWS({
  ...
  const distortionEntry$LWS = [originalTextContentGetter$LWS, function textContent$LWS() {
    if (this instanceof HTMLScriptElement$LWS || this instanceof SVGScriptElement$LWS) {
      var _sharedDom$getOrigina2$LWS;
      return (_sharedDom$getOrigina2$LWS = sharedDom$LWS.getOriginalScriptProperty(this)) != null ? _sharedDom$getOrigina2$LWS : shared$LWS.ReflectApply(originalTextContentGetter$LWS, this, []);
    }
      ...
      if (args$LWS.length) {
        ...
        if (callback$LWS !== null && callback$LWS !== undefined) {
          if (typeof callback$LWS !== 'function') {
            ...
            callback$LWS === eval) {
              throw new shared$LWS.LockerSecurityError('Cannot pass unsafe eval reference.');
            }
          }
        }
      }
