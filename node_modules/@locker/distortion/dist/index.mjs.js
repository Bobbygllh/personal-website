...
import { toSafeWeakMap as toSafeWeakMap$LWS, WeakMapCtor as WeakMapCtor$LWS, toSafeMap as toSafeMap$LWS, MapCtor as MapCtor$LWS, getUnmaskedFunction as getUnmaskedFunction$LWS, isMaskedFunction as isMaskedFunction$LWS, maskFunction as maskFunction$LWS, TypeErrorCtor as TypeErrorCtor$LWS, createUnmaskableTraps as createUnmaskableTraps$LWS, PromiseReject as PromiseReject$LWS, toSafeSet as toSafeSet$LWS, SetCtor as SetCtor$LWS, ReflectApply as ReflectApply$LWS, LockerSecurityError as LockerSecurityError$LWS, StringProtoToLowerCase as StringProtoToLowerCase$LWS, PromiseCtor as PromiseCtor$LWS, PromiseProtoThen as PromiseProtoThen$LWS, ReflectConstruct as ReflectConstruct$LWS, ReflectSetPrototypeOf as ReflectSetPrototypeOf$LWS, shallowCloneArray as shallowCloneArray$LWS, isObject as isObject$LWS, toSafeStringValue as toSafeStringValue$LWS, ReflectDefineProperty as ReflectDefineProperty$LWS, ReflectGet as ReflectGet$LWS, ReflectGetPrototypeOf as ReflectGetPrototypeOf$LWS, ReflectSet as ReflectSet$LWS, toSafeWeakSet as toSafeWeakSet$LWS, WeakSetCtor as WeakSetCtor$LWS, ObjectLookupOwnGetter as ObjectLookupOwnGetter$LWS, ObjectLookupOwnSetter as ObjectLookupOwnSetter$LWS, noop as noop$LWS, StringProtoSplit as StringProtoSplit$LWS, StringProtoReplace as StringProtoReplace$LWS, partialStructuredClone as partialStructuredClone$LWS, prependNamespaceMarker as prependNamespaceMarker$LWS, startsWithNamespaceMarker as startsWithNamespaceMarker$LWS, removeNamespaceMarker as removeNamespaceMarker$LWS, isObjectLike as isObjectLike$LWS, shallowCloneOptions as shallowCloneOptions$LWS, getNamespaceMarker as getNamespaceMarker$LWS, StringProtoSlice as StringProtoSlice$LWS, ReflectGetOwnPropertyDescriptor as ReflectGetOwnPropertyDescriptor$LWS, trackAsLiveTarget as trackAsLiveTarget$LWS, ArrayProtoJoin as ArrayProtoJoin$LWS, StringProtoIncludes as StringProtoIncludes$LWS, isGaterEnabledFeature as isGaterEnabledFeature$LWS, toSafeTemplateStringValue as toSafeTemplateStringValue$LWS, ReflectDeleteProperty as ReflectDeleteProperty$LWS, StringProtoMatch as StringProtoMatch$LWS, ArrayProtoIndexOf as ArrayProtoIndexOf$LWS, ArrayProtoSlice as ArrayProtoSlice$LWS, isRevokedProxy as isRevokedProxy$LWS, ENABLE_SANDBOXED_SAMEORIGIN_IFRAME_GATE as ENABLE_SANDBOXED_SAMEORIGIN_IFRAME_GATE$LWS, isNotAllowedToOverrideGaterEnabledFeature as isNotAllowedToOverrideGaterEnabledFeature$LWS, RegExpProtoTest as RegExpProtoTest$LWS, consoleWarn as consoleWarn$LWS, enquote as enquote$LWS, capitalizeFirstChar as capitalizeFirstChar$LWS, UNCOMPILED_LOCATION_NAME as UNCOMPILED_LOCATION_NAME$LWS, UNCOMPILED_TOP_NAME as UNCOMPILED_TOP_NAME$LWS, createRevokedProxy as createRevokedProxy$LWS, ObjectKeys as ObjectKeys$LWS, startsWithStorageNamespaceMarker as startsWithStorageNamespaceMarker$LWS, ArrayCtor as ArrayCtor$LWS, removeStorageNamespaceMarker as removeStorageNamespaceMarker$LWS, prependStorageNamespaceMarker as prependStorageNamespaceMarker$LWS, ProxyCtor as ProxyCtor$LWS, ObjectHasOwn as ObjectHasOwn$LWS, ObjectGetOwnPropertySymbols as ObjectGetOwnPropertySymbols$LWS, ArrayConcat as ArrayConcat$LWS, ReflectHas as ReflectHas$LWS, toSafeArray as toSafeArray$LWS, FunctionProtoBind as FunctionProtoBind$LWS, ObjectGetOwnPropertyDescriptors as ObjectGetOwnPropertyDescriptors$LWS, NumberIsInteger as NumberIsInteger$LWS, ObjectLookupOwnValue as ObjectLookupOwnValue$LWS } from '@locker/shared';
import { rootWindow as rootWindow$LWS, DocumentProtoDefaultViewGetter as DocumentProtoDefaultViewGetter$LWS, DOMExceptionCtor as DOMExceptionCtor$LWS, ElementProtoTagNameGetter as ElementProtoTagNameGetter$LWS, NodeProtoIsConnectedGetter as NodeProtoIsConnectedGetter$LWS, ElementProtoGetAttribute as ElementProtoGetAttribute$LWS, ElementProtoRemoveAttribute as ElementProtoRemoveAttribute$LWS, ElementProtoSetAttribute as ElementProtoSetAttribute$LWS, ElementProtoHasAttribute as ElementProtoHasAttribute$LWS, ElementProtoToggleAttribute as ElementProtoToggleAttribute$LWS, HTMLElementGlobalAttributesToPropertyName as HTMLElementGlobalAttributesToPropertyName$LWS, ElementAriaAttributesToPropertyName as ElementAriaAttributesToPropertyName$LWS, CUSTOM_ELEMENT_REGISTRY_ATTRIBUTE_NAME as CUSTOM_ELEMENT_REGISTRY_ATTRIBUTE_NAME$LWS, NodeProtoOwnerDocumentGetter as NodeProtoOwnerDocumentGetter$LWS, NodeProtoParentNodeGetter as NodeProtoParentNodeGetter$LWS, NAMESPACE_DEFAULT as NAMESPACE_DEFAULT$LWS, AttrProtoOwnerElementGetter as AttrProtoOwnerElementGetter$LWS, AttrProtoNameGetter as AttrProtoNameGetter$LWS, AttrProtoNamespaceURIGetter as AttrProtoNamespaceURIGetter$LWS, transformSourceText as transformSourceText$LWS, DocumentProtoCookieGetter as DocumentProtoCookieGetter$LWS, DocumentProtoCookieSetter as DocumentProtoCookieSetter$LWS, rootDocument as rootDocument$LWS, rootValidator as rootValidator$LWS, NodeProtoNodeNameGetter as NodeProtoNodeNameGetter$LWS, normalizeWindowOpenArguments as normalizeWindowOpenArguments$LWS, markForUnsafePropertyBlocking as markForUnsafePropertyBlocking$LWS, initWindowOpenChildWindow as initWindowOpenChildWindow$LWS, getValidator as getValidator$LWS, AttrProtoValueGetter as AttrProtoValueGetter$LWS, isScriptPropertyEvaluatorHookDefined as isScriptPropertyEvaluatorHookDefined$LWS, defineScriptAccessorProperty as defineScriptAccessorProperty$LWS, setOriginalScriptScriptProperty as setOriginalScriptScriptProperty$LWS, isScriptEvaluated as isScriptEvaluated$LWS, isScriptURLEvaluatorHookDefined as isScriptURLEvaluatorHookDefined$LWS, defineScriptEvaluatorProperty as defineScriptEvaluatorProperty$LWS, deleteOriginalScriptProperty as deleteOriginalScriptProperty$LWS, SCRIPT_HOOK_SOURCE_TEXT as SCRIPT_HOOK_SOURCE_TEXT$LWS, normalizeNamespacedAttributeName as normalizeNamespacedAttributeName$LWS, ElementProtoGetAttributeNode as ElementProtoGetAttributeNode$LWS, ElementProtoRemoveAttributeNode as ElementProtoRemoveAttributeNode$LWS, AttrProtoValueSetter as AttrProtoValueSetter$LWS, ElementProtoGetAttributeNodeNS as ElementProtoGetAttributeNodeNS$LWS, throwIfMarkedAsUnsafeInChildWindow as throwIfMarkedAsUnsafeInChildWindow$LWS, EventProtoCurrentTargetGetter as EventProtoCurrentTargetGetter$LWS, generateContextAssignmentCodeFromContextNames as generateContextAssignmentCodeFromContextNames$LWS, UNIVERSAL_CONTEXT_NAMES as UNIVERSAL_CONTEXT_NAMES$LWS, compileSourceText as compileSourceText$LWS, HTMLIFrameElementProtoSandboxGetter as HTMLIFrameElementProtoSandboxGetter$LWS, HTMLIFrameElementProtoSrcSetter as HTMLIFrameElementProtoSrcSetter$LWS, HTMLIFrameElementProtoSrcGetter as HTMLIFrameElementProtoSrcGetter$LWS, DOMTokenListProtoContains as DOMTokenListProtoContains$LWS, DOMTokenListProtoRemove as DOMTokenListProtoRemove$LWS, DOMTokenListProtoAdd as DOMTokenListProtoAdd$LWS, DOMTokenListProtoLengthGetter as DOMTokenListProtoLengthGetter$LWS, HTMLIFrameElementProtoSandboxSetter as HTMLIFrameElementProtoSandboxSetter$LWS, DOMTokenListProtoValueGetter as DOMTokenListProtoValueGetter$LWS, getOriginalScriptProperty as getOriginalScriptProperty$LWS, StorageProtoKey as StorageProtoKey$LWS, StorageProtoGetItem as StorageProtoGetItem$LWS, StorageProtoSetItem as StorageProtoSetItem$LWS, StorageProtoRemoveItem as StorageProtoRemoveItem$LWS, DocumentProtoCreateElementNS as DocumentProtoCreateElementNS$LWS, NAMESPACE_SVG as NAMESPACE_SVG$LWS, NAMESPACE_XLINK as NAMESPACE_XLINK$LWS, BlobProtoTypeGetter as BlobProtoTypeGetter$LWS, BlobProtoSlice as BlobProtoSlice$LWS, BlobProtoSizeGetter as BlobProtoSizeGetter$LWS, URLRevokeObjectURL as URLRevokeObjectURL$LWS, XhrCtor as XhrCtor$LWS, XhrProtoOpen as XhrProtoOpen$LWS, XhrProtoSend as XhrProtoSend$LWS, XhrProtoResponseTextGetter as XhrProtoResponseTextGetter$LWS, RequestProtoURLGetter as RequestProtoURLGetter$LWS, WindowLengthGetter as WindowLengthGetter$LWS, isWindow as isWindow$LWS, DocumentProtoImplementationGetter as DocumentProtoImplementationGetter$LWS, DOMImplementationProtoCreateDocument as DOMImplementationProtoCreateDocument$LWS, NAMESPACE_XHTML as NAMESPACE_XHTML$LWS, DocumentProtoDocumentElementGetter as DocumentProtoDocumentElementGetter$LWS, ElementProtoInnerHTMLSetter as ElementProtoInnerHTMLSetter$LWS, ElementProtoOuterHTMLGetter as ElementProtoOuterHTMLGetter$LWS } from '@locker/shared-dom';
import { lwsInternalPolicy as lwsInternalPolicy$LWS, ContentType as ContentType$LWS } from '@locker/internal-policy';
import { isSameOriginURL as isSameOriginURL$LWS, sanitizeURLForElement as sanitizeURLForElement$LWS, isValidURLScheme as isValidURLScheme$LWS, parseURL as parseURL$LWS, isValidURL as isValidURL$LWS, resolveURL as resolveURL$LWS, isMIMETypeAllowed as isMIMETypeAllowed$LWS } from '@locker/shared-url';
import { trusted as trusted$LWS } from '@locker/trusted-types';
import { sanitizeSvgHref as sanitizeSvgHref$LWS, blobSanitizer as blobSanitizer$LWS } from '@locker/html-sanitizer';
...
const definitionCache$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
const globalRegistryCache$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
const pivotCtorCache$LWS = toSafeMap$LWS(new MapCtor$LWS());
const sandboxRegistryCache$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
...
class VirtualRegistry$LWS {
  constructor(document$LWS, originalHTMLElementCtor$LWS = getUnmaskedFunction$LWS(ReflectApply$LWS(DocumentProtoDefaultViewGetter$LWS, document$LWS, []).HTMLElement)) {
    this._awaitingUpgrade = toSafeMap$LWS(new MapCtor$LWS());
    this._definedCtors = toSafeSet$LWS(new SetCtor$LWS());
    this._definitionByElement = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
    this._definitionByTag = toSafeMap$LWS(new MapCtor$LWS());
    this._pendingRegistryByElement = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
  ...
  applyDefine(cer$LWS, args$LWS) {
    ...
    if (options$LWS && options$LWS.extends) {
      throw new DOMExceptionCtor$LWS("NotSupportedError: 'extends' key in customElements.define() options is not supported.");
    }
    if (this._definitionByTag.has(tagName$LWS)) {
      throw new DOMExceptionCtor$LWS(`Failed to execute 'define' on 'CustomElementRegistry': the name "${tagName$LWS}" has already been used with this registry.`);
    }
    if (this._definedCtors.has(LocalCtor$LWS)) {
      throw new DOMExceptionCtor$LWS("Failed to execute 'define' on 'CustomElementRegistry': this constructor has already been used with this registry.");
    }
    ...
    if (PivotCtor$LWS === undefined) {
      ...
      ReflectApply$LWS(CustomElementRegistryProtoDefine$LWS, cer$LWS, [tagName$LWS, PivotCtor$LWS]);
    } else {
  ...
  applyUpgrade(cer$LWS, args$LWS) {
    ...
    const tagName$LWS = ReflectApply$LWS(ElementProtoTagNameGetter$LWS, element$LWS, []);
    const tagNameLowerCased$LWS = ReflectApply$LWS(StringProtoToLowerCase$LWS, tagName$LWS, []);
    ...
    if (definition$LWS) {
      ReflectApply$LWS(CustomElementRegistryProtoUpgrade$LWS, cer$LWS, [element$LWS]);
    }
  }
  applyWhenDefined(cer$LWS, args$LWS) {
    const tagName$LWS = args$LWS[0];
    const promise$LWS = ReflectApply$LWS(CustomElementRegistryProtoWhenDefined$LWS, cer$LWS, args$LWS);
    return new PromiseCtor$LWS((resolve$LWS, reject$LWS) => {
      ReflectApply$LWS(PromiseProtoThen$LWS, promise$LWS, [() => {
        const definition$LWS = this._definitionByTag.get(tagName$LWS);
        if (definition$LWS) {
  ...
  newCtor(instance$LWS, newTarget$LWS, originalHTMLElementCtor$LWS) {
    ...
    if (definition$LWS === undefined || typeof definition$LWS.PivotCtor !== 'function') {
      ...
      try {
        ReflectApply$LWS(ElementProtoTagNameGetter$LWS, this, []);
  ...
  scheduleConnectedCallback(instance$LWS, tagName$LWS) {
    ...
    if (awaiting$LWS === undefined) {
      awaiting$LWS = toSafeSet$LWS(new SetCtor$LWS());
  ...
  scheduleOrUpgrade(instance$LWS, tagName$LWS, originalDefinition$LWS) {
    ...
    if (definition$LWS) {
      ...
      ReflectSetPrototypeOf$LWS(instance$LWS, this._originalHTMLElementCtor.prototype);
    }
  }
  setDefinition(instance$LWS, definition$LWS) {
    ReflectSetPrototypeOf$LWS(instance$LWS, definition$LWS.LocalCtor.prototype);
  ...
  upgrade(instance$LWS, originalDefinition$LWS, definition$LWS) {
    ...
    const tagName$LWS = ReflectApply$LWS(ElementProtoTagNameGetter$LWS, instance$LWS, []);
    const tagNameLowerCased$LWS = ReflectApply$LWS(StringProtoToLowerCase$LWS, tagName$LWS, []);
    ...
    if (awaiting$LWS && awaiting$LWS.size) {
      ...
      // istanbul ignore else: currently unreachable via tests
      if (needsConnectedCallback$LWS && ReflectApply$LWS(NodeProtoIsConnectedGetter$LWS, instance$LWS, [])) {
        if (typeof connectedCallback$LWS === 'function') {
          ReflectApply$LWS(connectedCallback$LWS, instance$LWS, []);
        }
        awaiting$LWS.delete(instance$LWS);
...
function createDefinitionRecord$LWS(LocalCtor$LWS) {
  ...
  return {
    ...
    observedAttributesAsSet: observedAttributes$LWS ? toSafeSet$LWS(new SetCtor$LWS(observedAttributes$LWS)) : undefined,
...
const instanceRegistryMap$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
  ...
  return _a$LWS = class PivotCtor$LWS extends originalHTMLElementCtor$LWS {
    ...
    adoptedCallback() {
      ...
      if (adoptedCallback$LWS) {
        ReflectApply$LWS(adoptedCallback$LWS, this, []);
      }
    }
    attributeChangedCallback(attrName$LWS, oldValue$LWS, newValue$LWS) {
      ...
      originalDefinition$LWS === definition$LWS || definition$LWS.observedAttributesAsSet.has(attrName$LWS))) {
        ReflectApply$LWS(attributeChangedCallback$LWS, this, [attrName$LWS, oldValue$LWS, newValue$LWS]);
      }
    }
    connectedCallback() {
      ...
      if (definition$LWS) {
        ...
        if (connectedCallback$LWS) {
          ReflectApply$LWS(connectedCallback$LWS, this, []);
        }
      } else {
    ...
    disconnectedCallback() {
      ...
      if (definition$LWS) {
        ...
        if (disconnectedCallback$LWS) {
          ReflectApply$LWS(disconnectedCallback$LWS, this, []);
        }
      } else {
    ...
    formAssociatedCallback(form$LWS) {
      ...
      if (formAssociatedCallback$LWS) {
        ReflectApply$LWS(formAssociatedCallback$LWS, this, [form$LWS]);
      }
    }
    formDisabledCallback(disabled$LWS) {
      ...
      if (formDisabledCallback$LWS) {
        ReflectApply$LWS(formDisabledCallback$LWS, this, [disabled$LWS]);
      }
    }
    formResetCallback() {
      const definition$LWS = instanceRegistryMap$LWS.get(this).getDefinition(this);
      ...
      if (formResetCallback$LWS) {
        ReflectApply$LWS(formResetCallback$LWS, this, []);
      }
    }
    ...
    formStateRestoreCallback(state$LWS, reason$LWS) {
      ...
      if (formStateRestoreCallback$LWS) {
        ReflectApply$LWS(formStateRestoreCallback$LWS, this, [state$LWS, reason$LWS]);
      }
    }
  },
...
function getDefinitionForCtor$LWS(LocalCtor$LWS) {
  ...
  if (!isObject$LWS(proto$LWS)) {
    throw new TypeErrorCtor$LWS('Invalid custom element constructor.');
  }
...
function getNodeRegistry$LWS(document$LWS, node$LWS) {
  const key$LWS = ReflectApply$LWS(ElementProtoGetAttribute$LWS, node$LWS, [CUSTOM_ELEMENT_REGISTRY_ATTRIBUTE_NAME$LWS]);
  if (key$LWS === null) {
    return undefined;
  }
  ReflectApply$LWS(ElementProtoRemoveAttribute$LWS, node$LWS, [CUSTOM_ELEMENT_REGISTRY_ATTRIBUTE_NAME$LWS]);
  const ownerDoc$LWS = ReflectApply$LWS(NodeProtoOwnerDocumentGetter$LWS, node$LWS, []);
...
function getObservedAttributesDifference$LWS(originalDefinition$LWS, definition$LWS) {
  ...
  if (originalObservedAttributesAsSet$LWS === undefined) {
    return toSafeSet$LWS(new SetCtor$LWS(observedAttributes$LWS));
  }
  const difference$LWS = toSafeSet$LWS(new SetCtor$LWS());
  for (let i$LWS = 0, {
      length: length$LWS
...
function patchAttributes$LWS(instance$LWS, originalDefinition$LWS, definition$LWS) {
  ...
  instance$LWS.removeAttribute = maskFunction$LWS(function removeAttribute$LWS(attrName$LWS) {
    ...
    if (observedAttributesDifference$LWS.has(attrName$LWS)) {
      const old$LWS = ReflectApply$LWS(ElementProtoGetAttribute$LWS, this, args$LWS);
      ReflectApply$LWS(ElementProtoRemoveAttribute$LWS, this, args$LWS);
      args$LWS[1] = old$LWS;
      args$LWS[2] = null;
      ReflectApply$LWS(attributeChangedCallback$LWS, this, args$LWS);
    } else {
      ReflectApply$LWS(ElementProtoRemoveAttribute$LWS, this, args$LWS);
    }
  ...
  instance$LWS.setAttribute = maskFunction$LWS(function setAttribute$LWS(attrName$LWS, value$LWS) {
    ...
    if (observedAttributesDifference$LWS.has(attrName$LWS)) {
      const old$LWS = ReflectApply$LWS(ElementProtoGetAttribute$LWS, this, args$LWS);
      ReflectApply$LWS(ElementProtoSetAttribute$LWS, this, setAttributeArgs$LWS);
      args$LWS[1] = old$LWS;
  ...
  }, ElementProtoSetAttribute$LWS);
  instance$LWS.toggleAttribute = maskFunction$LWS(function toggleAttribute$LWS(attrName$LWS) {
    const args$LWS = [attrName$LWS];
    let returnValue$LWS;
    // `observedAttributesDifference` is a safe Set.
    if (observedAttributesDifference$LWS.has(attrName$LWS)) {
      const hasAttribute$LWS = ReflectApply$LWS(ElementProtoHasAttribute$LWS, this, args$LWS);
      const old$LWS = hasAttribute$LWS ? ReflectApply$LWS(ElementProtoGetAttribute$LWS, this, args$LWS) : null;
      returnValue$LWS = ReflectApply$LWS(ElementProtoToggleAttribute$LWS, this, args$LWS);
      args$LWS[1] = old$LWS;
      if (hasAttribute$LWS) {
        args$LWS[2] = null;
      }
  ...
  for (const originalAttrName$LWS of observedAttributesDifference$LWS) {
    ...
    if (attrPropName$LWS in instance$LWS) {
      ReflectDefineProperty$LWS(instance$LWS, attrPropName$LWS, {
        __proto__: null,
        enumerable: true,
        configurable: true,
        get() {
          return ReflectGet$LWS(ReflectGetPrototypeOf$LWS(this), attrPropName$LWS, this);
        },
        set(value$LWS) {
          ...
          const oldValue$LWS = ReflectApply$LWS(ElementProtoGetAttribute$LWS, this, [originalAttrName$LWS]);
          ...
          ReflectSet$LWS(ReflectGetPrototypeOf$LWS(this), attrPropName$LWS, value$LWS, this);
          const newValue$LWS = ReflectApply$LWS(ElementProtoGetAttribute$LWS, this, [originalAttrName$LWS]);
          if (oldValue$LWS !== newValue$LWS) {
            ReflectApply$LWS(attributeChangedCallback$LWS, this, [originalAttrName$LWS, oldValue$LWS, newValue$LWS]);
          }
        }
      });
    }
...
function patchCustomElementRegistry$LWS(globalObject$LWS, registry$LWS) {
  ...
  globalCustomElementRegistryProto$LWS.define = maskFunction$LWS(function define$LWS(...args$LWS) {
    if (this !== customElements$LWS) {
      ...
      // is to throw here.
      throw new TypeErrorCtor$LWS(ERR_ILLEGAL_INVOCATION$LWS);
    }
  ...
  globalCustomElementRegistryProto$LWS.whenDefined = maskFunction$LWS(function whenDefined$LWS(...args$LWS) {
    if (this !== customElements$LWS) {
      ...
      return PromiseReject$LWS(new TypeErrorCtor$LWS(ERR_ILLEGAL_INVOCATION$LWS));
    }
...
function patchHTMLElement$LWS(globalObject$LWS, registry$LWS) {
  ...
  globalObject$LWS.HTMLElement = maskFunction$LWS(function HTMLElement$LWS() {
    if (new.target === undefined) {
      throw new TypeErrorCtor$LWS(ERR_NO_NEW_OP_HTML_ELEMENT$LWS);
    }
    if (new.target === HTMLElement$LWS) {
      throw new TypeErrorCtor$LWS(ERR_ILLEGAL_CONSTRUCTOR$LWS);
    }
...
function triggerAttributeChangedCallbackDuringUpgrade$LWS(instance$LWS, originalDefinition$LWS) {
  ...
  for (let i$LWS = 0, {
    ...
    const attrName$LWS = observedAttributes$LWS[i$LWS];
    if (ReflectApply$LWS(ElementProtoHasAttribute$LWS, instance$LWS, [attrName$LWS])) {
      const newValue$LWS = ReflectApply$LWS(ElementProtoGetAttribute$LWS, instance$LWS, [attrName$LWS]);
      ReflectApply$LWS(attributeChangedCallback$LWS, instance$LWS, [attrName$LWS, null, newValue$LWS]);
    }
  }
}
// istanbul ignore next: dead code to be kept until 248
function unpatchCustomElementRegistry$LWS(globalObject$LWS) {
  ...
  globalCustomElementRegistryProto$LWS.define = getUnmaskedFunction$LWS(globalCustomElementRegistryProto$LWS.define);
  globalCustomElementRegistryProto$LWS.get = getUnmaskedFunction$LWS(globalCustomElementRegistryProto$LWS.get);
  globalCustomElementRegistryProto$LWS.upgrade = getUnmaskedFunction$LWS(globalCustomElementRegistryProto$LWS.upgrade);
  globalCustomElementRegistryProto$LWS.whenDefined = getUnmaskedFunction$LWS(globalCustomElementRegistryProto$LWS.whenDefined);
}
// istanbul ignore next: dead code to be kept until 248
function unpatchHTMLElement$LWS(globalObject$LWS) {
  globalObject$LWS.HTMLElement = getUnmaskedFunction$LWS(globalObject$LWS.HTMLElement);
}
function getSandboxCustomElementRegistry$LWS(document$LWS, key$LWS) {
  ...
  if (registries$LWS === undefined) {
    registries$LWS = toSafeMap$LWS(new MapCtor$LWS());
...
function registerShadowRootInSandbox$LWS(sandboxKey$LWS, shadowRoot$LWS) {
  const {
    [sandboxKey$LWS]: elementShadowRootRegistry$LWS = toSafeWeakSet$LWS(new WeakSetCtor$LWS())
...
function isContainerWithinAShadowRootAccessibleInThisSandbox$LWS(key$LWS, container$LWS) {
  ...
  } while (parentNode$LWS = ReflectApply$LWS(NodeProtoParentNodeGetter$LWS, parentNode$LWS, []));
  return false;
}
function initDistortionAbstractRangeEndContainerGetter$LWS({
  ...
  const originalEndContainerGetter$LWS = ObjectLookupOwnGetter$LWS(AbstractRange$LWS.prototype, 'endContainer');
  return function distortionEndContainerGetter$LWS({
    key: key$LWS
  }) {
    return [originalEndContainerGetter$LWS, function endContainer$LWS() {
      const realEndContainer$LWS = ReflectApply$LWS(originalEndContainerGetter$LWS, this, []);
...
function initDistortionAbstractRangeStartContainerGetter$LWS({
  ...
  const originalStartContainerGetter$LWS = ObjectLookupOwnGetter$LWS(AbstractRange$LWS.prototype, 'startContainer');
  return function distortionStartContainerGetter$LWS({
    key: key$LWS
  }) {
    return [originalStartContainerGetter$LWS, function startContainer$LWS() {
      const realStartContainer$LWS = ReflectApply$LWS(originalStartContainerGetter$LWS, this, []);
...
const attributeDistortionFactoriesCache$LWS = toSafeMap$LWS(new MapCtor$LWS());
const sandboxAttributeDistortionRegistryCache$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
...
function initDistortionAttrValueSetter$LWS({
  ...
  return function distortionAttrValueSetter$LWS(record$LWS) {
    return [originalAttrValueSetter$LWS, function value$LWS(val$LWS) {
      const ownerElement$LWS = ReflectApply$LWS(AttrProtoOwnerElementGetter$LWS, this, []);
...
function initDistortionCSSStyleRuleStyleGetter$LWS({
  ...
  const distortionEntry$LWS = [originalStyleGetter$LWS, function style$LWS() {
    return trackAsLiveTarget$LWS(ReflectApply$LWS(originalStyleGetter$LWS, this, []));
  }];
...
function initDistortionDocumentCreateElement$LWS({
  ...
  return function distortionDocumentCreateElement$LWS({
    ...
    return [originalDocumentCreateElement$LWS, function (...args$LWS) {
      ...
      if (ReflectApply$LWS(StringProtoIncludes$LWS, tagName$LWS, ['-'])) {
      ...
      return ReflectApply$LWS(originalDocumentCreateElement$LWS, this, args$LWS);
    }];
  };
}
function initDistortionDocumentCreateElementNS$LWS({
  ...
  return function distortionDocumentCreateElementNS$LWS({
    ...
    return [originalDocumentCreateElementNS$LWS, function (...args$LWS) {
      ...
      return ReflectApply$LWS(originalDocumentCreateElementNS$LWS, this, args$LWS);
    }];
  };
}
function domain$LWS() {
...
function throwLockerSecurityError$LWS(command$LWS, target$LWS) {
  throw new LockerSecurityError$LWS(`Cannot execute command '${command$LWS}' on ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, target$LWS, [])}.`);
}
function initDistortionDocumentExecCommand$LWS({
  ...
  const originalActiveElement$LWS = ObjectLookupOwnGetter$LWS(Document.prototype, 'activeElement');
  const originalIsContentEditable$LWS = ObjectLookupOwnGetter$LWS(HTMLElement$LWS.prototype, 'isContentEditable');
  return function distortionDocumentExecCommand$LWS({
    ...
    return [originalExecCommand$LWS, function execCommand$LWS(...args$LWS) {
      ...
      if (length$LWS >= 1) {
        ...
        const loweredCommand$LWS = ReflectApply$LWS(StringProtoToLowerCase$LWS, command$LWS, []);
          ...
          if (unsanitizedValue$LWS !== null && unsanitizedValue$LWS !== undefined) {
            ...
            if (loweredCommand$LWS === 'inserthtml') {
              ...
              if (type$LWS === 0 /* SandboxType.External */) {
                ...
                if (isSharedElement$s$LWS(activeElement$LWS) && ReflectApply$LWS(originalIsContentEditable$LWS, activeElement$LWS, [])) {
...
function initDistortionDocumentOpen$LWS({
  ...
  const distortionEntry$LWS = [originalDocumentOpen$LWS, function open$LWS(...args$LWS) {
    ...
    if (length$LWS >= 3) {
      ...
      const childWindow$LWS = ReflectApply$LWS(originalDocumentOpen$LWS, this, normalizedArgs$LWS);
      const {
        0: resourceUrl$LWS = ''
      } = normalizedArgs$LWS;
    ...
    if (isSharedElement$r$LWS(this)) {
      for (let i$LWS = 0, {
        ...
        if (!isAllowedSharedElementChild$6$LWS(argValue$LWS)) {
          const nodeNameOrString$LWS = argValue$LWS instanceof Node$LWS ? ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, argValue$LWS, []) : /* istanbul ignore next: currently unreachable via tests */toSafeStringValue$LWS(argValue$LWS);
          throw new LockerSecurityError$LWS(`Cannot insert ${nodeNameOrString$LWS} after ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
        }
      }
    }
    ...
    if (isSharedElement$q$LWS(this)) {
      ...
      for (let i$LWS = 0, {
        ...
        if (!isAllowedSharedElementChild$5$LWS(argValue$LWS)) {
          const nodeNameOrString$LWS = argValue$LWS instanceof Node$LWS ? ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, argValue$LWS, []) : /* istanbul ignore next: currently unreachable via tests */toSafeStringValue$LWS(argValue$LWS);
          throw new LockerSecurityError$LWS(`Cannot append ${nodeNameOrString$LWS} to ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
        }
      }
    }
...
function initDistortionElementAttachShadow$LWS({
  ...
  return function distortionElementAttachShadow$LWS({
    ...
    return [originalAttachShadow$LWS, function attachShadow$LWS(...args$LWS) {
      const shadowRoot$LWS = ReflectApply$LWS(originalAttachShadow$LWS, this, args$LWS);
      registerShadowRootInSandbox$LWS(key$LWS, shadowRoot$LWS);
      return shadowRoot$LWS;
    }];
  };
}
const namedNodeMapToElementCache$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
    ...
    if (isSharedElement$p$LWS(this)) {
      for (let i$LWS = 0, {
        ...
        if (!isAllowedSharedElementChild$4$LWS(argValue$LWS)) {
          const nodeNameOrString$LWS = argValue$LWS instanceof Node$LWS ? ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, argValue$LWS, []) : /* istanbul ignore next: currently unreachable via tests */toSafeStringValue$LWS(argValue$LWS);
          throw new LockerSecurityError$LWS(`Cannot insert ${nodeNameOrString$LWS} before ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
        }
      }
    }
...
function initDistortionElementGetInnerHTML$LWS({
  ...
  const distortionEntry$LWS = [originalGetInnerHTML$LWS, function getInnerHTML$LWS(...args$LWS) {
    ...
    return ReflectApply$LWS(originalGetInnerHTML$LWS, this, args$LWS);
  }];
  // istanbul ignore next: only runs in browsers with property, which no longer includes Chrome https://issues.chromium.org/issues/41492947
  ...
  if (!isScriptEvaluated$LWS(incomingThis$LWS)) {
    ...
    if (!isScriptURLEvaluatorHookDefined$LWS(incomingThis$LWS)) {
      defineScriptEvaluatorProperty$LWS(incomingThis$LWS, (context$LWS, defaultView$LWS, ownerDoc$LWS) => {
        ...
        ReflectDeleteProperty$LWS(incomingThis$LWS, property$LWS);
        // Set the script property immediately
        // after the evaluator hook fires to overwrite
        // the evaluator hook source text.
        ReflectApply$LWS(originalScriptPropertySetter$LWS, incomingThis$LWS, [valueAsTrustedString$LWS]);
      ...
      ReflectApply$LWS(originalScriptPropertySetter$LWS, incomingThis$LWS, [signedScriptHookSourceText$LWS]);
    }
    return true;
  }
  return false;
    ...
    return [originalInnerHTMLSetter$LWS, function innerHTML$LWS(value$LWS) {
      ...
      if (!isOwnerXMLDocument$LWS) {
        ...
        if (this instanceof HTMLScriptElement$LWS || this instanceof SVGScriptElement) {
          const scriptWasNotEvaluatedInScriptPropertySetter$LWS = scriptPropertySetters$LWS(this, 'innerHTML', trusted$LWS.createScript(value$LWS), originalInnerHTMLGetter$LWS, originalInnerHTMLSetter$LWS, distortions$LWS, sandboxEvaluator$LWS, trusted$LWS.createScript(SCRIPT_HOOK_SOURCE_TEXT$LWS));
...
function initDistortionElementInsertAdjacentHTML$LWS({
  ...
  return function distortionElementInsertAdjacentHTML$LWS({
    ...
    return [originalInsertAdjacentHTML$LWS, function insertAdjacentHTML$LWS(...args$LWS) {
      // istanbul ignore else: needs default platform behavior test
      if (args$LWS.length > 1) {
        const match$LWS = ReflectApply$LWS(StringProtoMatch$LWS, args$LWS[1], [allowedElementHTMLRegExp$LWS]);
        if (isSharedElement$m$LWS(this) && match$LWS === null) {
          throw new LockerSecurityError$LWS(`Cannot insert adjacent HTML to ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}`);
        }
        // This must be called to signal to the virtual
        // CustomElementRegistry that the next thing created
        // MAY CONTAIN a custom element, which must be marked for
  ...
  return function distortionElementOuterHTMLSetter$LWS({
    ...
    return [originalOuterHTMLSetter$LWS, function outerHTML$LWS(value$LWS) {
      ...
      if (isSharedElement$l$LWS(this)) {
        throw new LockerSecurityError$LWS(`Cannot set outerHTML of ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
      }
      // This must be called to signal to the virtual
      // CustomElementRegistry that the next thing created
      // MAY CONTAIN a custom element, which must be marked for
      ...
      ReflectApply$LWS(originalOuterHTMLSetter$LWS, this, [html$LWS]);
    }];
  };
}
const {
    ...
    if (isSharedElement$k$LWS(this)) {
      ...
      for (let i$LWS = 0, {
        ...
        if (!isAllowedSharedElementChild$2$LWS(argValue$LWS)) {
          const nodeNameOrString$LWS = argValue$LWS instanceof Node$LWS ? ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, argValue$LWS, []) : /* istanbul ignore next: currently unreachable via tests */toSafeStringValue$LWS(argValue$LWS);
          throw new LockerSecurityError$LWS(`Cannot prepend ${nodeNameOrString$LWS} to ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
        }
      }
    }
...
function initDistortionElementRemove$LWS({
  ...
  const distortionEntry$LWS = [originalRemove$LWS, function remove$LWS() {
    ...
    if (isSharedElement$j$LWS(this)) {
      throw new LockerSecurityError$LWS(`Cannot remove ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
    }
...
function initDistortionElementReplaceChildren$LWS({
  ...
  const distortionEntry$LWS = [originalReplaceChildren$LWS, function replaceChildren$LWS(...args$LWS) {
    ...
    if (isSharedElement$i$LWS(this)) {
      throw new LockerSecurityError$LWS(`Cannot replace children of ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
    }
...
function initDistortionElementReplaceWith$LWS({
  ...
  const distortionEntry$LWS = [originalReplaceWith$LWS, function replaceWith$LWS(...args$LWS) {
    ...
    if (isSharedElement$h$LWS(this)) {
      throw new LockerSecurityError$LWS(`Cannot replace ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
    }
...
function initDistortionElementSetAttributeNode$LWS({
  ...
  return function distortionElementSetAttributeNode$LWS(record$LWS) {
    return [originalSetAttributeNode$LWS, function setAttributeNode$LWS(...args$LWS) {
      ...
      const attrName$LWS = normalizeNamespacedAttributeName$LWS(ReflectApply$LWS(AttrProtoNameGetter$LWS, attr$LWS, []));
      const attrNamespace$LWS = ReflectApply$LWS(AttrProtoNamespaceURIGetter$LWS, attr$LWS, []);
      const normalizedNamespace$LWS = normalizeNamespace$LWS(attrNamespace$LWS);
      ...
      if (distortion$LWS) {
        ...
        if (newAttr$LWS) {
          const newValue$LWS = ReflectApply$LWS(AttrProtoValueGetter$LWS, newAttr$LWS, []);
          // Set the distorted attr value.
          ReflectApply$LWS(AttrProtoValueSetter$LWS, attr$LWS, [newValue$LWS]);
          // Replace old attr.
    ...
    return [originalSetHTML$LWS, function setHTML$LWS(...args$LWS) {
      ...
      if (!isOwnerXMLDocument$LWS) {
        ...
        if (isSharedElement$g$LWS(this)) {
          throw new LockerSecurityError$LWS(`Cannot setHTML of ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
        }
        // This must be called to signal to the virtual
        // CustomElementRegistry that the next thing created
        // MAY CONTAIN a custom element, which must be marked for
      ...
      ReflectApply$LWS(originalSetHTML$LWS, this, args$LWS);
    }];
  };
}
const {
    ...
    return [originalSetHTMLUnsafe$LWS, function innerHTML$LWS(value$LWS) {
      ...
      if (!isOwnerXMLDocument$LWS) {
        ...
        if (isSharedElement$f$LWS(this)) {
          throw new LockerSecurityError$LWS(`Cannot 'setHTMLUnsafe' of ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
        }
      ...
      ReflectApply$LWS(originalSetHTMLUnsafe$LWS, this, [value$LWS]);
    }];
  };
}
function initDistortionElementShadowRootGetter$LWS({
  ...
  return function distortionShadowRootGetter$LWS({
    ...
    return [originalShadowRootGetter$LWS, function shadowRoot$LWS() {
      const realShadowRoot$LWS = ReflectApply$LWS(originalShadowRootGetter$LWS, this, []);
    ...
    return [originalToggleAttribute$LWS, function toggleAttribute$LWS(...args$LWS) {
      ...
      if (length$LWS > 0) {
        ...
        if (distortion$LWS) {
          ...
          ReflectApply$LWS(distortion$LWS, this, distortionArgs$LWS);
...
function initDistortionFunction$LWS({
  ...
  return function distortionFunction$LWS({
    ...
    return [originalFunction$LWS, function Function$LWS(...args$LWS) {
      ...
      if (!length$LWS) {
        return ReflectApply$LWS(sandboxFuncCtor$LWS, this, []);
      }
      ...
      ReflectApply$LWS(sandboxFuncCtor$LWS, this, [funcBody$LWS]);
      // Make function body empty to create the wire-frame.
      args$LWS[lastIndex$LWS] = '';
      const wireFunc$LWS = ReflectApply$LWS(sandboxFuncCtor$LWS, this, args$LWS);
      const prefix$LWS = `${generateContextAssignmentCodeFromContextNames$LWS(UNIVERSAL_CONTEXT_NAMES$LWS)};`;
      const header$LWS = ReflectApply$LWS(StringProtoReplace$LWS, `${wireFunc$LWS}`, [funcFooterRegExp$LWS, '']);
...
function initDistortionHTMLElementDatasetGetter$LWS({
  ...
  const distortionEntry$LWS = [originalDatasetGetter$LWS, function dataset$LWS() {
    return trackAsLiveTarget$LWS(ReflectApply$LWS(originalDatasetGetter$LWS, this, []));
  }];
...
function initDistortionHTMLElementInnerTextSetter$LWS({
  ...
  const distortionEntry$LWS = [originalInnerTextSetter$LWS, function innerText$LWS(value$LWS) {
    ...
    if (isSharedElement$e$LWS(this)) {
      throw new LockerSecurityError$LWS(`Cannot set innerText of ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
    }
...
function initDistortionHTMLElementOuterTextSetter$LWS({
  ...
  const distortionEntry$LWS = [originalOuterTextSetter$LWS, function outerText$LWS(value$LWS) {
    ...
    if (isSharedElement$d$LWS(this)) {
      throw new LockerSecurityError$LWS(`Cannot set outerText of ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])}.`);
    }
...
function initDistortionIFrameElementContentDocumentGetter$LWS({
  ...
  const distortionEntry$LWS = [originalContentDocumentGetter$LWS, function get$LWS() {
    ...
    return isRevokedProxy$LWS(this) ? /* istanbul ignore next: currently unreachable via tests */null : ReflectApply$LWS(originalContentDocumentGetter$LWS, this, []);
  }];
...
function initDistortionIFrameElementContentWindowGetter$LWS({
  ...
  const distortionEntry$LWS = [originalContentWindowGetter$LWS, function get$LWS() {
    ...
    return isRevokedProxy$LWS(this) ? /* istanbul ignore next: currently unreachable via tests */null : ReflectApply$LWS(originalContentWindowGetter$LWS, this, []);
  }];
...
function initDistortionHTMLIFrameElementSandboxGetter$LWS({
  ...
  const originalSandboxGetter$LWS = ObjectLookupOwnGetter$LWS(HTMLIFrameElement$LWS.prototype, 'sandbox');
  return function distortionHTMLIFrameElementSandboxGetter$LWS({
    key: key$LWS
  }) {
    return [originalSandboxGetter$LWS, function sandbox$LWS() {
      const sandboxTokenList$LWS = ReflectApply$LWS(HTMLIFrameElementProtoSandboxGetter$LWS, this, []);
...
const sameOriginSandboxedByLWS$LWS = toSafeWeakSet$LWS(new WeakSetCtor$LWS());
function enforceSandboxAllowScriptsForSameOriginIframeRealm$LWS(iframe$LWS) {
  const sandboxTokenList$LWS = ReflectApply$LWS(HTMLIFrameElementProtoSandboxGetter$LWS, iframe$LWS, []);
  const srcValue$LWS = ReflectApply$LWS(HTMLIFrameElementProtoSrcGetter$LWS, iframe$LWS, []);
  ...
  if (ReflectApply$LWS(DOMTokenListProtoContains$LWS, sandboxTokenList$LWS, [ALLOW_SAME_ORIGIN_TOKEN$LWS])) {
    ...
    ReflectApply$LWS(DOMTokenListProtoRemove$LWS, sandboxTokenList$LWS, [ALLOW_SAME_ORIGIN_TOKEN$LWS]);
  ...
  if (srcValue$LWS !== '' && srcValue$LWS !== ABOUT_BLANK_TOKEN$LWS) {
    ...
    if (!ReflectApply$LWS(DOMTokenListProtoContains$LWS, sandboxTokenList$LWS, [ALLOW_SCRIPTS_TOKEN$LWS])) {
      // Track that LWS added this token
      sameOriginSandboxedByLWS$LWS.add(iframe$LWS);
      ReflectApply$LWS(DOMTokenListProtoAdd$LWS, sandboxTokenList$LWS, [ALLOW_SCRIPTS_TOKEN$LWS]);
    }
  } else {
    if (srcValue$LWS === ABOUT_BLANK_TOKEN$LWS && sameOriginSandboxedByLWS$LWS.has(iframe$LWS)) {
      ...
      ReflectApply$LWS(DOMTokenListProtoRemove$LWS, sandboxTokenList$LWS, [ALLOW_SCRIPTS_TOKEN$LWS]);
      // If after removing ALLOW_SCRIPTS_TOKEN, the sandbox attribute is empty,
      // we can remove it entirely.
      if (ReflectApply$LWS(DOMTokenListProtoLengthGetter$LWS, sandboxTokenList$LWS, []) === 0) {
        ReflectApply$LWS(ElementProtoRemoveAttribute$LWS, iframe$LWS, ['sandbox']);
      }
    }
  }
}
...
function initDistortionHTMLIFrameElementSandboxSetter$LWS({
  ...
  return function distortionHTMLIFrameElementSandboxSetter$LWS(record$LWS) {
    function sandbox$LWS(value$LWS) {
      ReflectApply$LWS(HTMLIFrameElementProtoSandboxSetter$LWS, this, [value$LWS]);
      if (isGaterEnabledFeature$LWS(ENABLE_SANDBOXED_SAMEORIGIN_IFRAME_GATE$LWS) && isNotAllowedToOverrideGaterEnabledFeature$LWS(record$LWS.key, ENABLE_SANDBOXED_SAMEORIGIN_IFRAME_GATE$LWS)) {
        enforceSandboxAllowScriptsForSameOriginIframeRealm$LWS(this);
      }
    }
...
function initDistortionHTMLLinkElementRelSetter$LWS({
  ...
  function rel$LWS(value$LWS) {
    ...
    if (isValidRelValue$LWS(valueAsString$LWS)) {
      ReflectApply$LWS(originalRelSetter$LWS, this, [valueAsString$LWS]);
      return;
    }
...
function initDistortionHTMLLinkElementRelListSetter$LWS({
  ...
  const distortionEntry$LWS = [originalRelListSetter$LWS, function relList$LWS(relListValue$LWS) {
    const string$LWS = relList$LWS instanceof DOMTokenList$LWS ? /* istanbul ignore next: needs default platform behavior test */ReflectApply$LWS(DOMTokenListProtoValueGetter$LWS, relListValue$LWS, []) : toSafeStringValue$LWS(relListValue$LWS);
...
function initDistortionHTMLObjectElementDataSetter$LWS({
  ...
  function data$LWS(value$LWS) {
    ...
    ReflectApply$LWS(originalDataSetter$LWS, this, [trusted$LWS.createScriptURL(urlString$LWS)]);
  }
...
const descriptorCaches$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
...
function createGetThrowerFactoryInitializer$LWS(proto$LWS, key$LWS) {
  const originalGet$LWS = ObjectLookupOwnGetter$LWS(proto$LWS, key$LWS);
...
function addBlockedPropertyDistortionFactoryInitializers$LWS({
  ...
  if (descsCache$LWS === undefined) {
    descsCache$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
...
const scriptURLs$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
  ...
  const {
    ...
    [distortionName$LWS](url$LWS) {
      ...
      const evaluator$LWS = function evaluator$LWS(sourceText$LWS) {
        const ownerDoc$LWS = ReflectApply$LWS(NodeProtoOwnerDocumentGetter$LWS, targetElement$LWS, []);
...
function initDistortionHTMLScriptElementSrcGetter$LWS({
  ...
  const distortionEntry$LWS = [originalSrcGetter$LWS, function src$LWS() {
    ...
    return (_getScriptURL$LWS = getScriptURL$LWS(this)) != null ? _getScriptURL$LWS : ReflectApply$LWS(originalSrcGetter$LWS, this, []);
  }];
  ...
  return function distortionHTMLScriptElementTextSetter$LWS({
    ...
    return [originalTextSetter$LWS, function text$LWS(value$LWS) {
      ...
      if (this instanceof HTMLScriptElement$LWS) {
        const scriptWasNotEvaluatedInScriptPropertySetter$LWS = scriptPropertySetters$LWS(this, 'text', trusted$LWS.createScript(value$LWS), originalTextGetter$LWS, originalTextSetter$LWS, distortions$LWS, sandboxEvaluator$LWS, trusted$LWS.createScript(SCRIPT_HOOK_SOURCE_TEXT$LWS));
        // istanbul ignore else
        if (scriptWasNotEvaluatedInScriptPropertySetter$LWS) {
          return;
        }
      ...
      ReflectApply$LWS(originalTextSetter$LWS, this, [value$LWS]);
    }];
  };
}
function initDistortionHTMLScriptElementTextContentGetter$LWS({
  ...
  const distortionEntry$LWS = [originalTextContentGetter$LWS, function textContent$LWS() {
    ...
    return (_getOriginalScriptPro$LWS = getOriginalScriptProperty$LWS(this)) != null ? _getOriginalScriptPro$LWS : ReflectApply$LWS(originalTextContentGetter$LWS, this, []);
  }];
  // istanbul ignore next: currently not implemented in Chrome (used for coverage collection)
  return function distortionHTMLScriptElementSrcGetter$LWS() {
    return distortionEntry$LWS;
...
function initDistortionHTMLScriptElementTextContentSetter$LWS({
  ...
  return function distortionHTMLScriptElementTextContentSetter$LWS(record$LWS) {
    ...
    return [originalTextContentSetter$LWS, function textContent$LWS(value$LWS) {
      const valueAsString$LWS = trusted$LWS.createScript(value$LWS);
      const scriptWasNotEvaluatedInScriptPropertySetter$LWS = scriptPropertySetters$LWS(this, 'textContent', valueAsString$LWS, originalTextContentGetter$LWS, originalTextContentSetter$LWS, distortions$LWS, sandboxEvaluator$LWS, trusted$LWS.createScript(SCRIPT_HOOK_SOURCE_TEXT$LWS));
      if (scriptWasNotEvaluatedInScriptPropertySetter$LWS) {
        return;
      }
...
function initDistortionNavigatorServiceWorkerGetter$LWS({
  ...
  const distortionEntry$LWS = [originalServiceWorkerGetter$LWS, noop$LWS];
  ...
  const distortionEntry$LWS = [originalInsertBefore$LWS, function insertBefore$LWS(...args$LWS) {
    ...
    if (args$LWS.length) {
      ...
      if (isSharedElement$c$LWS(this) && !isAllowedSharedElementChild$1$LWS(node$LWS)) {
        throw new LockerSecurityError$LWS(`Cannot insert child ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, node$LWS, [])} into ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])},`);
      }
    }
  ...
  return function distortionNodeValueSetter$LWS(record$LWS) {
    return [originalNodeValueSetter$LWS, function nodeValue$LWS(value$LWS) {
      ...
      if (this instanceof Attr$LWS) {
        const ownerEl$LWS = ReflectApply$LWS(AttrProtoOwnerElementGetter$LWS, this, []);
        if (ownerEl$LWS === null) {
          ReflectApply$LWS(originalNodeValueSetter$LWS, this, [value$LWS]);
          return;
        }
        const attrName$LWS = ReflectApply$LWS(AttrProtoNameGetter$LWS, this, []);
        const attrNamespace$LWS = ReflectApply$LWS(AttrProtoNamespaceURIGetter$LWS, this, []);
        ...
        // istanbul ignore next: needs default platform behavior test
        if (distortion$LWS) {
          ReflectApply$LWS(distortion$LWS, ownerEl$LWS, [value$LWS]);
          return;
        }
      }
      // istanbul ignore next: needs default platform behavior test
  ...
  const distortionEntry$LWS = [originalRemoveChild$LWS, function removeChild$LWS(...args$LWS) {
    ...
    if (args$LWS.length) {
      ...
      if (isSharedElement$b$LWS(child$LWS)) {
        throw new LockerSecurityError$LWS(`Cannot remove ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, child$LWS, [])}.`);
      }
    }
    // istanbul ignore next: needs default platform behavior test
  ...
  const distortionEntry$LWS = [originalReplaceChild$LWS, function replaceChild$LWS(...args$LWS) {
    ...
    if (length$LWS > 1) {
      ...
      if (isSharedElement$a$LWS(child$LWS)) {
        throw new LockerSecurityError$LWS(`Cannot replace ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, child$LWS, [])}.`);
      }
    }
    // istanbul ignore next: needs default platform behavior test
    return ReflectApply$LWS(originalReplaceChild$LWS, this, args$LWS);
...
function initDistortionNodeTextContentGetter$LWS({
  ...
  const distortionEntry$LWS = [originalTextContentGetter$LWS, function textContent$LWS() {
    if (this instanceof HTMLScriptElement$LWS || this instanceof SVGScriptElement$LWS) {
      ...
      return (_getOriginalScriptPro2$LWS = getOriginalScriptProperty$LWS(this)) != null ? _getOriginalScriptPro2$LWS : ReflectApply$LWS(originalTextContentGetter$LWS, this, []);
    }
  ...
  return function distortionNodeTextContentSetter$LWS(record$LWS) {
    ...
    return [originalTextContentSetter$LWS, function textContent$LWS(value$LWS) {
      ...
      if (this instanceof Attr$LWS) {
        ...
        // istanbul ignore next: needs default platform behavior test
        if (distortion$LWS) {
          ReflectApply$LWS(distortion$LWS, ownerEl$LWS, [valueAsString$LWS]);
          return;
        }
      ...
      // istanbul ignore else: needs default platform behavior test
        ...
        throw new LockerSecurityError$LWS(`Cannot set textContent of ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, this, [])} elements.`);
      }
      ReflectApply$LWS(originalTextContentSetter$LWS, this, [valueAsString$LWS]);
    }];
  };
...
function initDistortionPerformanceMark$LWS({
  ...
  const distortionEntry$LWS = [originalMark$LWS, function mark$LWS(...args$LWS) {
    try {
      return ReflectApply$LWS(originalMark$LWS, this, args$LWS);
    } catch (error) {
      if (args$LWS.length > 1 && error instanceof DOMException) {
        const providedOptions$LWS = args$LWS[1];
        if (isObject$LWS(providedOptions$LWS)) {
...
function initDistortionPerformanceMeasure$LWS({
  ...
  const distortionEntry$LWS = [originalMeasure$LWS, function measure$LWS(...args$LWS) {
    try {
      return ReflectApply$LWS(originalMeasure$LWS, this, args$LWS);
    } catch (error) {
      if (args$LWS.length > 1 && error instanceof DOMException) {
        const providedOptions$LWS = args$LWS[1];
        if (isObject$LWS(providedOptions$LWS)) {
...
function initDistortionRangeDeleteContents$LWS({
  ...
  const originalStartContainerGetter$LWS = ObjectLookupOwnGetter$LWS(AbstractRangeProto$LWS, 'startContainer');
...
function initDistortionRangeInsertNode$LWS({
  ...
  const originalCommonAncestorContainerGetter$LWS = ObjectLookupOwnGetter$LWS(Range.prototype, 'commonAncestorContainer');
      ...
      [methodName$LWS](...args$LWS) {
        ...
        if (args$LWS.length) {
          ...
          if (isSharedElement$5$LWS(node$LWS)) {
            throw new LockerSecurityError$LWS(`Cannot call ${methodName$LWS} with ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, node$LWS, [])}.`);
          }
        }
  ...
  const distortionEntry$LWS = [originalSelectionCollapse$LWS, function collapse$LWS(...args$LWS) {
    if (args$LWS.length) {
      ...
      if (node$LWS && isSharedElement$4$LWS(node$LWS)) {
        throw new LockerSecurityError$LWS(`Cannot collapse selection to ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, node$LWS, [])}`);
      }
    }
    return ReflectApply$LWS(originalSelectionCollapse$LWS, this, args$LWS);
  }];
  ...
  const distortionEntry$LWS = [originalSelectionExtend$LWS, function extend$LWS(...args$LWS) {
    if (args$LWS.length) {
      ...
      if (isSharedElement$3$LWS(node$LWS)) {
        throw new LockerSecurityError$LWS(`Cannot extend selection to ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, node$LWS, [])}`);
      }
    }
    return ReflectApply$LWS(originalSelectionExtend$LWS, this, args$LWS);
  }];
  ...
  const distortionEntry$LWS = [originalSelectionSelectAllChildren$LWS, function selectAllChildren$LWS(...args$LWS) {
    if (args$LWS.length) {
      ...
      if (isSharedElement$2$LWS(node$LWS)) {
        throw new LockerSecurityError$LWS(`Cannot select all children of ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, node$LWS, [])}`);
      }
    }
    return ReflectApply$LWS(originalSelectionSelectAllChildren$LWS, this, args$LWS);
  }];
  ...
  const distortionEntry$LWS = [originalSelectionSetBaseAndExtent$LWS, function setBaseAndExtent$LWS(...args$LWS) {
    ...
    if (args$LWS.length === 4) {
      ...
      if (anchorNodeIsShared$LWS || focusNodeIsShared$LWS) {
        ...
        throw new LockerSecurityError$LWS(`Cannot set selection with ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, subject$LWS, [])}`);
      }
    }
    return ReflectApply$LWS(originalSelectionSetBaseAndExtent$LWS, this, args$LWS);
  }];
  ...
  const distortionEntry$LWS = [originalSelectionSetPosition$LWS, function setPosition$LWS(...args$LWS) {
    if (args$LWS.length) {
      ...
      if (node$LWS && isSharedElement$LWS(node$LWS)) {
        throw new LockerSecurityError$LWS(`Cannot set position with ${ReflectApply$LWS(NodeProtoNodeNameGetter$LWS, node$LWS, [])}`);
      }
    }
    return ReflectApply$LWS(originalSelectionSetPosition$LWS, this, args$LWS);
  }];
...
function initDistortionShadowRootInnerHTMLSetter$LWS({
  ...
  return function distortionShadowRootInnerHTMLSetter$LWS({
    ...
    return [originalInnerHTMLSetter$LWS, function innerHTML$LWS(value$LWS) {
      ...
      // association to this sandbox.
      setCustomElementsRegistry$LWS(document$LWS, key$LWS);
      ReflectApply$LWS(originalInnerHTMLSetter$LWS, this, [lwsInternalPolicy$LWS.createHTML(value$LWS, key$LWS, ContentType$LWS.HTML)]);
    }];
  };
}
function initDistortionShadowRootSetHTMLUnsafe$LWS({
  ...
  return function distortionShadowRootSetHTMLUnsafe$LWS({
    ...
    return [originalSetHTMLUnsafe$LWS, function setHTMLUnsafe$LWS(value$LWS) {
      ...
      // association to this sandbox.
      setCustomElementsRegistry$LWS(document$LWS, key$LWS);
      ReflectApply$LWS(originalSetHTMLUnsafe$LWS, this, [lwsInternalPolicy$LWS.createHTML(value$LWS, key$LWS, ContentType$LWS.HTML)]);
    }];
  };
}
...
const storageToMetaMap$LWS = toSafeWeakMap$LWS(new WeakMapCtor$LWS());
...
function createStorageProxy$LWS(storageTarget$LWS) {
  const proxy$LWS = new ProxyCtor$LWS(storageTarget$LWS, {
    ...
    get(target$LWS, key$LWS, receiver$LWS) {
      ...
      if (ObjectHasOwn$LWS(storage$LWS, markedKey$LWS)) {
    ...
    set(target$LWS, key$LWS, value$LWS) {
      ...
      const markedKey$LWS = prependStorageNamespaceMarker$LWS(key$LWS, namespace$LWS);
      ReflectApply$LWS(StorageProtoSetItem$LWS, storage$LWS, [markedKey$LWS, value$LWS]);
      return true;
    },
    defineProperty(target$LWS, key$LWS, unsafePartialDesc$LWS) {
      ...
      const markedKey$LWS = prependStorageNamespaceMarker$LWS(key$LWS, namespace$LWS);
      return ReflectDefineProperty$LWS(storage$LWS, markedKey$LWS, safeDesc$LWS);
    },
    deleteProperty(target$LWS, key$LWS) {
      ...
      const markedKey$LWS = prependStorageNamespaceMarker$LWS(key$LWS, namespace$LWS);
      return ReflectDeleteProperty$LWS(storage$LWS, markedKey$LWS);
    },
...
function initDistortionSVGElementStyleGetter$LWS({
  ...
  const originalStyleGetter$LWS = ObjectLookupOwnGetter$LWS(SVGElement$LWS.prototype, 'style');
  const distortionEntry$LWS = [originalStyleGetter$LWS, function style$LWS() {
    return trackAsLiveTarget$LWS(ReflectApply$LWS(originalStyleGetter$LWS, this, []));
  }];
...
const script$LWS = ReflectApply$LWS(DocumentProtoCreateElementNS$LWS, document, [NAMESPACE_SVG$LWS, 'script']);
function initDistortionSVGScriptElementHrefGetter$LWS({
  ...
  const originalHrefGetter$LWS = ObjectLookupOwnGetter$LWS(SVGScriptElement$LWS.prototype, 'href');
  const distortionEntry$LWS = [originalHrefGetter$LWS, function href$LWS() {
    ...
    if (typeof url$LWS === 'string') {
      ReflectApply$LWS(originalSetAttribute$LWS, script$LWS, ['href', trusted$LWS.createScriptURL(url$LWS)]);
      return ReflectApply$LWS(originalHrefGetter$LWS, script$LWS, []);
    }
    // istanbul ignore next: needs default platform behavior test
    return ReflectApply$LWS(originalHrefGetter$LWS, this, []);
  }];
...
function initDistortionURLCreateObjectURL$LWS({
  ...
  return function distortionURLCreateObjectURL$LWS({
    ...
    return [originalCreateObjectURL$LWS, function createObjectURL$LWS(blobObject$LWS) {
      ...
      // non-accepted types.
      let outURL$LWS = ReflectApply$LWS(originalCreateObjectURL$LWS, this, [blobObject$LWS]);
      if (
      ...
      if (HTML_MIME_TYPES_LIST$LWS.includes(loweredBlobType$LWS)) {
        ...
        if (!isEqualDomString$LWS(trusted$LWS.createHTML(responseText$LWS), trusted$LWS.createHTML(sanitized$LWS)) || isInherentlyUnsecure$LWS(responseText$LWS)) {
          URLRevokeObjectURL$LWS(outURL$LWS);
...
function initDistortionWindowFramesGetter$LWS({
  ...
  const createFramesProxy$LWS = () => {
    ...
    const framesLengthGetter$LWS = ReflectApply$LWS(FunctionProtoBind$LWS, WindowLengthGetter$LWS, [globalObject$LWS]);
    ...
    const getFrameByNameKey$LWS = key$LWS => {
      ...
      !ObjectHasOwn$LWS(globalObject$LWS, key$LWS) &&
      // ...Or its prototype.
    ...
    class ShadowWindowPropertiesHandler$LWS extends ShadowFramesPrototypeHandler$LWS {
      ...
      ownKeys() {
        ...
        ReflectSetPrototypeOf$LWS(unsafeDescs$LWS, null);
...
function initDistortionWindowGetComputedStyle$LWS({
  ...
  const distortionEntry$LWS = [originalGetComputedStyle$LWS, function getComputedStyle$LWS(...args$LWS) {
    return trackAsLiveTarget$LWS(ReflectApply$LWS(originalGetComputedStyle$LWS, this, args$LWS));
  }];
...
function initDistortionWindowOpen$LWS({
  ...
  const distortionEntry$LWS = [originalWindowOpen$LWS, function open$LWS(...args$LWS) {
    const normalizedArgs$LWS = normalizeWindowOpenArguments$LWS(args$LWS);
    const childWindow$LWS = ReflectApply$LWS(originalWindowOpen$LWS, this, normalizedArgs$LWS);
    const {
      0: resourceUrl$LWS = ''
    } = normalizedArgs$LWS;
    // In 256, limit this restriction to urls that can be treated as same-origin
...
function replaceDocumentContent$LWS(doc$LWS, content$LWS) {
  ...
  ReflectApply$LWS(ElementProtoInnerHTMLSetter$LWS, newDocEl$LWS, [content$LWS]);
  return newDoc$LWS;
}
  ...
  return function distortionXMLHttpRequestResponseGetter$LWS({
    ...
    return [originalResponseGetter$LWS, function response$LWS() {
      ...
      if (rawResponse$LWS instanceof Document$LWS) {
        const docEl$LWS = ReflectApply$LWS(DocumentProtoDocumentElementGetter$LWS, rawResponse$LWS, []);
...
function initDistortionXMLHttpRequestResponseXMLGetter$LWS({
  ...
  return function distortionXMLHttpRequestResponseXMLGetter$LWS({
    ...
    return [originalResponseXMLGetter$LWS, function responseXML$LWS() {
      ...
      // association to this sandbox.
      setCustomElementsRegistry$LWS(document$LWS, key$LWS);
      const docEl$LWS = ReflectApply$LWS(DocumentProtoDocumentElementGetter$LWS, rawResponseXML$LWS, []);
      const content$LWS = ReflectApply$LWS(ElementProtoOuterHTMLGetter$LWS, docEl$LWS, []);
...
export { DataTransferBlockedProperties$LWS as DataTransferBlockedProperties, DocumentBlockedProperties$LWS as DocumentBlockedProperties, ElementBlockedProperties$LWS as ElementBlockedProperties, EventBlockedProperties$LWS as EventBlockedProperties, HTMLElementBlockedAttributes$LWS as HTMLElementBlockedAttributes, HTMLElementBlockedProperties$LWS as HTMLElementBlockedProperties, HTMLEmbedElementBlockedProperties$LWS as HTMLEmbedElementBlockedProperties, HTMLIFrameElementBlockedAttributes$LWS as HTMLIFrameElementBlockedAttributes, HTMLIFrameElementBlockedProperties$LWS as HTMLIFrameElementBlockedProperties, HTMLObjectElementBlockedProperties$LWS as HTMLObjectElementBlockedProperties, HTMLScriptElementBlockedAttributes$LWS as HTMLScriptElementBlockedAttributes, HTMLScriptElementBlockedProperties$LWS as HTMLScriptElementBlockedProperties, SVGElementBlockedAttributes$LWS as SVGElementBlockedAttributes, SVGElementBlockedProperties$LWS as SVGElementBlockedProperties, UIEventBlockedProperties$LWS as UIEventBlockedProperties, WindowBlockedProperties$LWS as WindowBlockedProperties, XSLTProcessorBlockedProperties$LWS as XSLTProcessorBlockedProperties, addBlockedAttributeDistortionFactoryInitializers$LWS as addBlockedAttributeDistortionFactoryInitializers, addBlockedPropertyDistortionFactoryInitializers$LWS as addBlockedPropertyDistortionFactoryInitializers, distortionFactoryInitializerToggleSwitches$LWS as distortionFactoryInitializerToggleSwitches, externalDistortionFactoryInitializers$LWS as externalDistortionFactoryInitializers, externalKeyedDistortionFactoryInitializers$LWS as externalKeyedDistortionFactoryInitializers, finalizeAttributeDistortions$LWS as finalizeAttributeDistortions, initDistortionWindowPostMessage$LWS as initDistortionWindowPostMessage, internalDistortionFactoryInitializers$LWS as internalDistortionFactoryInitializers, internalKeyedDistortionFactoryInitializers$LWS as internalKeyedDistortionFactoryInitializers, patchGlobalObject$LWS as patchGlobalObject, unpatchGlobalObject$LWS as unpatchGlobalObject };
/*! version: 0.24.6 */
