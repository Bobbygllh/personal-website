...
class StyleDeduplicator extends HTMLElement {
    connectedCallback() {
        ...
        if (stylesheet) {
            ...
            if (!element) {
                throw new Error(`<lwc-style> tag found with no corresponding <style id="${styleId}"> tag`);
            }
 ...
 */
function registerLwcStyleComponent() {
...
if (typeof process === 'object' &&
    ...
    window.__lwcClearStylesheetCache = () => stylesheetCache.clear();
}

exports.registerLwcStyleComponent = registerLwcStyleComponent;
/** version: 8.22.4 */
