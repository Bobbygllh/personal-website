...
var ModuleRegistry = class {
  ...
  async resolve(id, importer) {
    ...
    if (useImporter && importer && (0, import_url.isUrl)(resolved)) {
  ...
  checkModuleSignature(name, signature) {
    ...
    const currentSig = moduleDef.signatures ? moduleDef.signatures.ownHash : void 0;
  ...
  async getModuleDependencyRecord(dependency) {
    ...
    if ((0, import_url.isUrl)(resolvedDepId)) {
